...
<div class="main-container" id="container">
    <div class="layout-px-spacing" style="width:100%">
        <p class="titulo">
            ...
            | <a href="<?= site_url('farm/add_persona_index/') . $farm_id; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?= translate('add_item_lang'); ?></a> | <a href="<?= site_url('farm/index/' . $provider_id); ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> <?= translate('back_lang'); ?>
            </a>
        </p>
        <div class="col-xs-12">
