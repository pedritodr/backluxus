                ...
                <div class="widget-content widget-content-area">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                <input type="number" min="0" class="form-control input-sm" id="days" name="days" required placeholder="<?= translate('days_credit_lang'); ?>">
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <label><?= translate("hectare_lang"); ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control input-sm" id="hectare" name="hectare" required placeholder="<?= translate('hectare_lang'); ?>">
                            </div>
                        </div>
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control input-sm" id="name_legal" name="name_legal" required placeholder="<?= translate('name_legal_lang'); ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control input-sm" id="address_farm" name="address_farm" required placeholder="<?= translate('address_farm_lang'); ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
