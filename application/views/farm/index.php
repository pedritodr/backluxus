        ...
        <div class="col-xs-12">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <h3 class="text-simple"><?= translate('listar_providers_lang'); ?></h3>
                </div><!-- /.box-header -->
                <div class="widget-content widget-content-area">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th><?= translate("owner_lang"); ?></th>
                                    <th><?= translate("days_credit_lang"); ?></th>
                                            ...
                                            <td>
                                                <div class="btn-group mb-4 mr-2" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnOutline">
                                                        <a class="dropdown-item" href="<?= site_url('farm/update_index_provider/' . $item->provider_id); ?>"><i class="fa fa-edit"></i> <?= translate("edit_lang"); ?></a>
                                                        <a class="dropdown-item" href="<?= site_url('farm/index/' . $item->provider_id); ?>"> <?= translate("farms_lang"); ?></a>
                                                        <a class="dropdown-item btn btn-danger" href="javascript:void(0)" onclick="deleteProvider('<?= $item->provider_id ?>')"><i class="fa fa-edit"></i> <?= translate("delete_lang"); ?></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
