            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <?= form_open_multipart("subport/update"); ?>
                        <input type="hidden" name="subport_id" value="<?= $subport_object->subport_id; ?>" />
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-sm" name="nombre" value="<?= $subport_object->name; ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-cogs"></i></span>
                                            <input type="text" class="form-control input-sm" name="cod" value="<?= $subport_object->code; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="destination" name="destination" class="form-control select2 input-sm" data-placeholder="Seleccione una opción" style="width: 100%">
                                                <?php if ($all_destinations) { ?>
                                                    <?php foreach ($all_destinations as $item) { ?>
                                                        <option <?php if ($item->destination_id == $subport_object->destination_id) { ?> selected <?php } ?> value="<?= $item->destination_id; ?>"><?= $item->name; ?></option>
                                                    <?php }  ?>
                                                <?php }  ?>
