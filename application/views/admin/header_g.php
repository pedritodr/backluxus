...
<!-- Mirrored from designreset.com/cork/ltr/demo10/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Dec 2020 17:05:05 GMT -->
...
<head>
    ...
    <link href="<?= base_url() ?>admin_template/assets/css/loader.css" rel="stylesheet" type="text/css" />
    <script src="<?= base_url() ?>admin_template/assets/js/loader.js"></script>
    ...
    <link href="<?= base_url() ?>admin_template/plugins/apex/apexcharts.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url() ?>admin_template/assets/css/dashboard/dash_1.css" rel="stylesheet" type="text/css" class="dashboard-analytics" />
    <link href="<?= base_url() ?>admin_template/assets/css/scrollspyNav.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url() ?>admin_template/plugins/apex/apexcharts.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>admin_template/plugins/table/datatable/datatables.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>admin_template/plugins/table/datatable/dt-global_style.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>admin_template/plugins/select2/select2.min.css">
    <link href="<?= base_url() ?>admin_template/plugins/animate/animate.css" rel="stylesheet" type="text/css" />
    <script src="<?= base_url() ?>admin_template/plugins/sweetalerts/promise-polyfill.js"></script>
    <link href="<?= base_url() ?>admin_template/plugins/sweetalerts/sweetalert2.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url() ?>admin_template/plugins/sweetalerts/sweetalert.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url() ?>admin_template/assets/css/components/custom-sweetalert.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url() ?>admin_template/assets/css/components/custom-modal.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>admin_template/plugins/editors/quill/quill.snow.css">
    <link href="<?= base_url() ?>admin_template/assets/css/components/cards/card.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="<?= base_url() ?>admin_template/plugins/editors/markdown/simplemde.min.css">
    ...
    <div class="header-container fixed-top">
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item flex-row navbar-dropdown">
                ...
                <!--      <li class="nav-item dropdown notification-dropdown">
                    <a target="_blank" href="<?= site_url(); ?>" class="nav-link bs-tooltip" data-placement="bottom" title="Ir al mall">
