...
!function () {
    ...
    function c() {
        var b = a(".sidebar");
        a.fn.ace_sidebar && b.ace_sidebar(), a.fn.ace_sidebar_scroll && b.ace_sidebar_scroll({include_toggle: !1 || ace.vars.safari || ace.vars.ios_safari}), a.fn.ace_sidebar_hover && b.ace_sidebar_hover({
            sub_hover_delay: 750,
    ...
    function d() {
        if (a.fn.ace_ajax) {
            ...
            var b = {
                close_active: !0, default_url: "page/index", content_url: function (a) {
            ...
            if ("fixed" == b.css("position")) {
                ...
                if (b.css({
                    ...
                    t.css(1 == t.length && "fixed" == t.css("position") ? {
                        ...
                        "max-width": h - 2,
                        "z-index": s + 1
                    } : {left: "", right: "", top: "", width: "", "max-width": "", "z-index": ""})
                }
        ...
        this.force_reload = !1, this.loadUrl = function (a, b) {
            ...
            if (!j) {
                ...
                g.trigger(i = a.Event("ajaxloadstart"), {
                    ...
                    var j = null, l = "";
                    if ("function" == typeof h.settings.update_active)j = h.settings.update_active.call(null, c, b); else if (h.settings.update_active === !0 && c && (j = a('a[data-url="' + c + '"]'), j.length > 0)) {
                        var m = j.closest(".nav");
                        if (m.length > 0) {
                    ...
                    }, 10), "function" == typeof h.settings.update_title ? h.settings.update_title.call(null, c, b, l) : h.settings.update_title === !0 && f(l), d || a("html,body").animate({scrollTop: 0}, 250), g.trigger("ajaxloadcomplete", {
                        url: b,
                        hash: c
                    }), h.stopLoading()
                }))
        ...
        if (l) {
            ...
            var w, x, y = function () {
                ...
                if (!v && f.sidebar_fixed) {
                    i.wrap('<div class="nav-wrap-up pos-rel" />'), i.after("<div><div></div></div>"), i.wrap('<div class="nav-wrap" />'), f.settings.include_toggle || j.css({"z-index": 1}), f.settings.include_shortcuts || k.css({"z-index": 99}), p = i.parent().next().ace_scroll({
                        size: y(),
                        mouseWheelLock: !0,
                        hoverReset: !1,
                        dragEvent: !0,
            ...
            this.scroll_to_active = function () {
                ...
                this.is_scrolling = !0, d && (r.css({
                    height: x,
                    width: 8
                }), p.prev().css({"max-height": w}), u.update({size: w}), u.enable(), u.reset()), d && u.is_active() ? h.addClass("sidebar-scroll") : this.is_scrolling && this.disable()
            }, this.disable = function () {
                this.is_scrolling = !1, p && (p.css({height: "", "max-height": ""}), r.css({
                    height: "",
                    width: ""
                }), p.prev().css({"max-height": ""}), u.disable()), parseInt(l.style.top) < 0 && f.settings.smooth_scroll && a.support.transition.end ? i.one(a.support.transition.end, function () {
        ...
        o.on(y, ".nav-list li, .sidebar-shortcuts", function () {
            if (q = o.ace_sidebar("vars"), !q.collapsible) {
                ...
                if (g)if (j) {
                    ...
                    if (!m.is_visible() || !d && n != x || r)if (a(g).addClass("can-scroll"), r || d) {
                        var s = this;
                        setTimeout(function () {
                            k.call(s, g)
                        }, 0)
