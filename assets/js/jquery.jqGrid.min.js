...
function tableToGrid(a, b) {
    jQuery(a).each(function () {
        if (!this.grid) {
            ...
            var a = jQuery(this).width(), c = jQuery("tr td:first-child input[type=checkbox]:first", jQuery(this)), d = jQuery("tr td:first-child input[type=radio]:first", jQuery(this)), e = c.length > 0, f = !e && d.length > 0, g = e || f, h = [], i = [];
            ...
            jQuery("tbody > tr", jQuery(this)).each(function () {
                ...
                jQuery("td", jQuery(this)).each(function () {
                    if (0 === b && g) {
                        var c = jQuery("input", jQuery(this)), d = c.attr("value");
...
!function ($) {
    ...
    $.jgrid = $.jgrid || {}, $.extend($.jgrid, {
        version: "4.6.0", htmlDecode: function (a) {
            ...
            if (void 0 === d && (d = $.jgrid.formatter.date), void 0 === d.parseRe && (d.parseRe = /[#%\\\/:_;.,\t\s-]/), d.masks.hasOwnProperty(a) && (a = d.masks[a]), b && null != b)if (isNaN(b - 0) || "u" !== String(a).toLowerCase())if (b.constructor === Date)o = b; else if (null !== l) {
            ...
            var a = $("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div>"), b = a.appendTo("body").find("td").width();
        ...
        return this.each(function () {
            if (!this.grid) {
                var b = $.extend(!0, {
                    ...
                    dragMove: function (a) {
                        if (this.resizing) {
                            var c, d, e = a.clientX - this.resizing.startX, f = this.headers[this.resizing.idx], g = "ltr" === b.direction ? f.width + e : f.width - e;
                            g > 33 && (this.curGbox.css({left: this.resizing.sOL + e}), b.forceFit === !0 ? (c = this.headers[this.resizing.idx + b.nv], d = "ltr" === b.direction ? c.width - e : c.width + e, d > 33 && (f.newWidth = g, c.newWidth = d)) : (this.newWidth = "ltr" === b.direction ? b.tblwidth + e : b.tblwidth - e, f.newWidth = g))
                        }
                    },
                    dragEnd: function () {
                        if (this.hDiv.style.cursor = "default", this.resizing) {
                            var a = this.resizing.idx, d = this.headers[a].newWidth || this.headers[a].width;
                    ...
                    populateVisible: function () {
                        ...
                        if (a) {
                            ...
                            if (e) {
                                d.prevRowHeight = e;
                                var h, i, j, k = b.rowNum, l = d.scrollTop = d.bDiv.scrollTop, m = Math.round(f.position().top) - l, n = m + f.height(), o = e * k;
                ...
                var g = $("<div class='ui-jqgrid-view'></div>"), h = $.jgrid.msie;
                ...
                var j = ["shiftKey", "altKey", "ctrlKey"], k = function (a, b) {
                    return a = parseInt(a, 10), isNaN(a) ? b || 0 : a
                }, l = function (a, b, e, f, g, h) {
                    var i, j = c.p.colModel[a], k = j.align, l = 'style="', m = j.classes, n = j.name, o = [];
                    ...
                    if (void 0 !== h.formatter) {
                        ...
                        var i = {rowId: a, colModel: h, gid: c.p.id, pos: d};
                    ...
                    var f = '<input role="checkbox" type="checkbox" id="jqg_' + c.p.id + "_" + a + '" class="cbox" name="jqg_' + c.p.id + "_" + a + '"' + (e ? 'checked="checked"' : "") + "/>", g = l(b, d, "", null, a, !0);
                    return '<td role="gridcell" ' + g + ">" + f + "</td>"
                }, q = function (a, b, c, d) {
                    var e = (parseInt(c, 10) - 1) * parseInt(d, 10) + 1 + b, f = l(a, b, e, null, b, !0);
                    ...
                    var a, b, d, e = c.p.data.length, f = c.p.rownumbers === !0 ? 1 : 0, g = c.p.multiselect === !0 ? 1 : 0, h = c.p.subGrid === !0 ? 1 : 0;
                    ...
                    var h, i = "-1", j = "", k = b ? "display:none;" : "", l = "ui-widget-content jqgrow ui-row-" + c.p.direction + (d ? " " + d : "") + (g ? " ui-state-highlight" : ""), m = $(c).triggerHandler("jqGridRowAttr", [e, f, a]);
                    ...
                    var g = new Date, h = "local" !== c.p.datatype && c.p.loadonce || "xmlstring" === c.p.datatype, i = "_id_", j = c.p.xmlReader, l = "local" === c.p.datatype ? "local" : "xml";
                    if (h && (c.p.data = [], c.p._index = {}, c.p.localReader.id = i), c.p.reccount = 0, $.isXMLDoc(a)) {
                        ...
                        var m, n, u, w, x, y, z, A, B, C, D = $(c), E = 0, F = c.p.multiselect === !0 ? 1 : 0, G = 0, H = c.p.rownumbers === !0 ? 1 : 0, I = [], J = {}, K = [], L = c.p.altRows === !0 ? c.p.altclass : "";
                        ...
                        var N, O = M.length, P = 0, Q = [], R = parseInt(c.p.rowNum, 10), S = c.p.scroll ? $.jgrid.randId() : 1;
                        if (O > 0 && c.p.page <= 0 && (c.p.page = 1), M && O) {
                            f && (R *= f + 1);
                            var T, U = $.isFunction(c.p.afterInsertRow), V = !1;
                            for (c.p.grouping && (V = c.p.groupingView.groupCollapse === !0, T = $.jgrid.getMethod("groupingPrepare")); O > P;) {
                                ...
                                } else for (m = 0; m < I.length; m++)u = $.jgrid.getXmlData(A, I[m]), J[c.p.colModel[m + F + G + H].name] = u, K.push(o(B, u, m + F + G + H, P + d, A, J));
                        ...
                        if (c.p.treeGrid || c.p.scroll || (c.grid.bDiv.scrollTop = 0), c.p.reccount = E, c.p.treeANode = -1, c.p.userDataOnFooter && D.jqGrid("footerData", "set", c.p.userData, !0), h && (c.p.records = O, c.p.lastpage = Math.ceil(O / R)), e || c.updatepager(!1, !0), h) {
                            for (; O > E;) {
                                ...
                                } else for (m = 0; m < I.length; m++)u = $.jgrid.getXmlData(A, I[m]), J[c.p.colModel[m + F + G + H].name] = u;
                    ...
                    if (a) {
                        -1 !== c.p.treeANode || c.p.scroll ? d = d > 1 ? d : 1 : (t.call(c, !1, !0), d = 1);
                        var h, i, j = "_id_", l = "local" !== c.p.datatype && c.p.loadonce || "jsonstring" === c.p.datatype;
                        ...
                        var m, n, u, w, x, y, z, A, B, C, D, E, F = $(c), G = 0, H = [], I = c.p.multiselect ? 1 : 0, J = c.p.subGrid === !0 ? 1 : 0, K = c.p.rownumbers === !0 ? 1 : 0, L = s(I + J + K), M = r(i), N = {}, O = [], P = c.p.altRows === !0 ? c.p.altclass : "";
                        ...
                        var Q, R, S = parseInt(c.p.rowNum, 10), T = c.p.scroll ? $.jgrid.randId() : 1, U = !1;
                        f && (S *= f + 1), "local" !== c.p.datatype || c.p.deselectAfterSort || (U = !0);
                        var V, W = $.isFunction(c.p.afterInsertRow), X = [], Y = !1;
                        ...
                        if (c.p.treeGrid || c.p.scroll || (c.grid.bDiv.scrollTop = 0), c.p.reccount = G, c.p.treeANode = -1, c.p.userDataOnFooter && F.jqGrid("footerData", "set", c.p.userData, !0), l && (c.p.records = z, c.p.lastpage = Math.ceil(z / S)), e || c.updatepager(!1, !0), l) {
                            for (; z > G && A[G];) {
                                if (w = A[G], D = $.jgrid.getAccessor(w, B), void 0 === D && ("number" == typeof B && null != c.p.colModel[B + I + J + K] && (D = $.jgrid.getAccessor(w, c.p.colModel[B + I + J + K].name)), void 0 === D && (D = T + G, 0 === H.length && h.cell))) {
                                    ...
                                    D = null != cb && void 0 !== cb[B] ? cb[B] : D, cb = null
                                }
                                if (w) {
                    ...
                    var b, d, e, f = c.p.multiSort ? [] : "", g = [], h = !1, i = {}, j = [], k = [];
                    if ($.isArray(c.p.data)) {
                        ...
                        if (c.p.ignoreCase && (p = p.ignoreCase()), c.p.search === !0) {
                            ...
                            if (q)"string" == typeof q && (q = $.jgrid.parse(q)), a(q); else try {
                        ...
                        var s = p.select(), t = parseInt(c.p.rowNum, 10), u = s.length, v = parseInt(c.p.page, 10), w = Math.ceil(u / t), x = {};
                    ...
                    var d, e, f, g, h, i, j, l, m = "", n = c.p.pager ? "_" + $.jgrid.jqID(c.p.pager.substr(1)) : "", o = c.p.toppager ? "_" + c.p.toppager.substr(1) : "";
                    if (f = parseInt(c.p.page, 10) - 1, 0 > f && (f = 0), f *= parseInt(c.p.rowNum, 10), h = f + c.p.reccount, c.p.scroll) {
                        ...
                        if (q) {
                            var r = f * q, s = parseInt(c.p.records, 10) * q;
                            $(">div:first", c.grid.bDiv).css({height: s}).children("div:first").css({
                                height: r,
                                display: r ? "" : "none"
                    ...
                    if (!c.grid.hDiv.loading) {
                        var b, d, e = c.p.scroll && a === !1, f = {}, g = c.p.prmNames;
                        ...
                        var h = $.isFunction(c.p.loadComplete), i = h ? c.p.loadComplete : null, j = 0;
                        ...
                        var o = c.p.scroll ? c.rows.length - 1 : 1, p = $(c).triggerHandler("jqGridBeforeRequest");
                    ...
                    var d, e, g, h, i, j, l, m = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>", n = "", o = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", p = "", q = function (a) {
                        var b;
                    ...
                    "ltr" === f && (o += p), o += "</tr></tbody></table>", c.p.viewrecords === !0 && $("td#" + a + "_" + c.p.recordpos, "#" + d).append("<div dir='" + f + "' style='text-align:" + c.p.recordpos + "' class='ui-paging-info'></div>"), $("td#" + a + "_" + c.p.pagerpos, "#" + d).append(o), j = $(".ui-jqgrid").css("font-size") || "11px", $(document.body).append("<div id='testpg' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:" + j + ";visibility:hidden;' ></div>"), i = $(o).clone().appendTo("#testpg").width(), $("#testpg").remove(), i > 0 && ("" !== n && (i += 50), $("td#" + a + "_" + c.p.pagerpos, "#" + d).width(i)), c.p._nvtd = [], c.p._nvtd[0] = Math.floor(i ? (c.p.width - i) / 2 : c.p.width / 3), c.p._nvtd[1] = 0, o = null, $(".ui-pg-selbox", "#" + d).bind("change", function () {
                        ...
                        var a = k(c.p.page, 1), d = k(c.p.lastpage, 1), e = !1, f = !0, g = !0, h = !0, i = !0;
                    ...
                    var d, e, f = "", g = c.p.colModel, h = !1, i = c.p.frozenColumns ? b : c.grid.headers[a].el, j = "";
                    ...
                    if (c.p.colModel[b].sortable && !(c.p.savedRow.length > 0)) {
                        if (d || (c.p.lastsort === b ? "asc" === c.p.sortorder ? c.p.sortorder = "desc" : "desc" === c.p.sortorder && (c.p.sortorder = "asc") : c.p.sortorder = c.p.colModel[b].firstsortorder || "asc", c.p.page = 1), c.p.multiSort)F(b, f); else {
                            if (e) {
                                if (c.p.lastsort === b && c.p.sortorder === e && !d)return;
                                c.p.sortorder = e
                            }
                            var g = c.grid.headers[c.p.lastsort].el, h = c.p.frozenColumns ? f : c.grid.headers[b].el;
                    ...
                    var a, b, e, f, g = 0, h = $.jgrid.cell_width ? 0 : k(c.p.cellLayout, 0), i = 0, j = k(c.p.scrollOffset, 0), l = !1, m = 0;
                    ...
                    var b = $(c.grid.headers[a].el), d = [b.position().left + b.outerWidth()];
                    ...
                    var b, d = c.grid.headers, e = $.jgrid.getCellIndex(a);
                ...
                if (c.p.sortorder = c.p.sortorder.toLowerCase(), $.jgrid.cell_width = $.jgrid.cellWidth(), c.p.grouping === !0 && (c.p.scroll = !1, c.p.rownumbers = !1, c.p.treeGrid = !1, c.p.gridview = !0), this.p.treeGrid === !0) {
                    ...
                    "local" !== c.p.datatype && (c.p.localReader = {id: "_id_"})
                }
                ...
                var N, O, P, Q, R, S, T, U, V, W = "<thead><tr class='ui-jqgrid-labels' role='rowheader'>", X = "", Y = "", Z = [], _ = [], ab = [];
                if (c.p.shrinkToFit === !0 && c.p.forceFit === !0)for (e = c.p.colModel.length - 1; e >= 0; e--)if (!c.p.colModel[e].hidden) {
                    c.p.colModel[e].resizable = !1;
                    break
                }
                if ("horizontal" === c.p.viewsortcols[1] && (X = " ui-i-asc", Y = " ui-i-desc"), N = h ? "class='ui-th-div-ie'" : "", V = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + X + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + f + "'></span>", V += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + Y + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + f + "'></span></span>", c.p.multiSort)for (Z = c.p.sortname.split(","), e = 0; e < Z.length; e++)ab = $.trim(Z[e]).split(" "), Z[e] = $.trim(ab[0]), _[e] = ab[1] ? $.trim(ab[1]) : c.p.sortorder || "asc";
                for (e = 0; e < this.p.colNames.length; e++) {
                    var bb = c.p.headertitles ? ' title="' + $.jgrid.stripHtml(c.p.colNames[e]) + '"' : "";
                    W += "<th id='" + c.p.id + "_" + c.p.colModel[e].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + f + "'" + bb + ">", O = c.p.colModel[e].index || c.p.colModel[e].name, W += "<div id='jqgh_" + c.p.id + "_" + c.p.colModel[e].name + "' " + N + ">" + c.p.colNames[e], c.p.colModel[e].width = c.p.colModel[e].width ? parseInt(c.p.colModel[e].width, 10) : 150, "boolean" != typeof c.p.colModel[e].title && (c.p.colModel[e].title = !0), c.p.colModel[e].lso = "", O === c.p.sortname && (c.p.lastsort = e), c.p.multiSort && (ab = $.inArray(O, Z), -1 !== ab && (c.p.colModel[e].lso = _[ab])), W += V + "</div></th>"
                }
                if (W += "</tr></thead>", V = null, $(this).append(W), $("thead tr:first th", this).hover(function () {
                    ...
                    $("#cb_" + $.jgrid.jqID(c.p.id), this).bind("click", function () {
                        ...
                        }), c.p.selrow = null, cb = !1), $(c).triggerHandler("jqGridSelectAll", [cb ? c.p.selarrrow : db, cb]), $.isFunction(c.p.onSelectAll) && c.p.onSelectAll.call(c, cb ? c.p.selarrrow : db, cb)
                    })
                }
                if (c.p.autowidth === !0) {
                    var eb = $(i).innerWidth();
                ...
                var gb = $("tr:first", W), hb = "<tr class='jqgfirstrow' role='row' style='height:auto'>";
                if (c.p.disableClick = !1, $("th", gb).each(function (a) {
                        ...
                        var b = "";
                        c.p.colModel[a].hidden && ($(this).css("display", "none"), b = "display:none;"), hb += "<td role='gridcell' style='height:0px;width:" + P + "px;" + b + "'></td>", d.headers[a] = {
                            width: P,
                            el: this
                        }, R = c.p.colModel[a].sortable, "boolean" != typeof R && (c.p.colModel[a].sortable = !0, R = !0);
                        var e = c.p.colModel[a].name;
                        "cb" !== e && "subgrid" !== e && "rn" !== e && c.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"), R && (c.p.multiSort ? c.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), c.p.colModel[a].lso && $("div span.ui-icon-" + c.p.colModel[a].lso, this).removeClass("ui-state-disabled")) : c.p.colModel[a].lso && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + c.p.colModel[a].lso, this).removeClass("ui-state-disabled")) : c.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), a === c.p.lastsort && $("div span.ui-icon-" + c.p.sortorder, this).removeClass("ui-state-disabled")) : a === c.p.lastsort && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + c.p.sortorder, this).removeClass("ui-state-disabled"))), c.p.footerrow && (fb += "<td role='gridcell' " + l(a, 0, "", null, "", !1) + ">&#160;</td>")
                ...
                c.p.footerrow && (fb += "</tr></tbody></table>"), hb += "</tr>", U = document.createElement("tbody"), this.appendChild(U), $(this).addClass("ui-jqgrid-btable").append(hb), hb = null;
                var jb = $("<table class='ui-jqgrid-htable' style='width:" + c.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(W), kb = c.p.caption && c.p.hiddengrid === !0 ? !0 : !1, lb = $("<div class='ui-jqgrid-hbox" + ("rtl" === f ? "-rtl" : "") + "'></div>");
                W = null, d.hDiv = document.createElement("div"), $(d.hDiv).css({width: d.width + "px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(lb), $(lb).append(jb), jb = null, kb && $(d.hDiv).hide(), c.p.pager && ("string" == typeof c.p.pager ? "#" !== c.p.pager.substr(0, 1) && (c.p.pager = "#" + c.p.pager) : c.p.pager = "#" + $(c.p.pager).attr("id"), $(c.p.pager).css({width: d.width + "px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(i), kb && $(c.p.pager).hide(), E(c.p.pager, "")), c.p.cellEdit === !1 && c.p.hoverrows === !0 && $(c).bind("mouseover", function (a) {
                ...
                $(c).before(d.hDiv).click(function (a) {
                    ...
                    var b = $(S).hasClass("cbox"), d = $(c).triggerHandler("jqGridBeforeSelectRow", [T[0].id, a]);
                    if (d = d === !1 || "stop" === d ? !1 : !0, d && $.isFunction(c.p.beforeSelectRow) && (d = c.p.beforeSelectRow.call(c, T[0].id, a)), "A" !== S.tagName && ("INPUT" !== S.tagName && "TEXTAREA" !== S.tagName && "OPTION" !== S.tagName && "SELECT" !== S.tagName || b) && d === !0)if (mb = T[0].id, nb = $.jgrid.getCellIndex(S), ob = $(S).closest("td,th").html(), $(c).triggerHandler("jqGridCellSelect", [mb, nb, ob, a]), $.isFunction(c.p.onCellSelect) && c.p.onCellSelect.call(c, mb, nb, ob, a), c.p.cellEdit === !0)if (c.p.multiselect && b)$(c).jqGrid("setSelection", mb, !0, a); else {
                        mb = T[0].rowIndex;
                        try {
                            $(c).jqGrid("editCell", mb, nb, !0)
                        } catch (e) {
                        }
                    } else if (c.p.multikey)a[c.p.multikey] ? $(c).jqGrid("setSelection", mb, !0, a) : c.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(c.p.id) + "_" + mb).is(":checked"), $("#jqg_" + $.jgrid.jqID(c.p.id) + "_" + mb)[c.p.useProp ? "prop" : "attr"]("checked", b)); else if (c.p.multiselect && c.p.multiboxonly)if (b)$(c).jqGrid("setSelection", mb, !0, a); else {
                        ...
                        }), c.p.selarrrow = [], $(c).jqGrid("setSelection", mb, !0, a)
                    ...
                    if (c.p.treeGrid === !0 && (c.p.datatype = c.p.treedatatype), b && b.current && c.grid.selectionPreserver(c), "local" === c.p.datatype ? ($(c).jqGrid("resetSelection"), c.p.data.length && u()) : c.p.treeGrid || (c.p.selrow = null, c.p.multiselect && (c.p.selarrrow = [], D(!1)), c.p.savedRow = []), c.p.scroll && t.call(c, !0, !1), b && b.page) {
                        var d = b.page;
                        d > c.p.lastpage && (d = c.p.lastpage), 1 > d && (d = 1), c.p.page = d, c.grid.bDiv.scrollTop = c.grid.prevRowHeight ? (d - 1) * c.grid.prevRowHeight * c.p.rowNum : 0
                    }
                    ...
                    S = a.target, T = $(S, c.rows).closest("tr.jqgrow"), 0 !== $(T).length && (mb = T[0].rowIndex, nb = $.jgrid.getCellIndex(S), $(c).triggerHandler("jqGridDblClickRow", [$(T).attr("id"), mb, nb, a]), $.isFunction(c.p.ondblClickRow) && c.p.ondblClickRow.call(c, $(T).attr("id"), mb, nb, a))
                }).bind("contextmenu", function (a) {
                    S = a.target, T = $(S, c.rows).closest("tr.jqgrow"), 0 !== $(T).length && (c.p.multiselect || $(c).jqGrid("setSelection", T[0].id, !0, a), mb = T[0].rowIndex, nb = $.jgrid.getCellIndex(S), $(c).triggerHandler("jqGridRightClickRow", [$(T).attr("id"), mb, nb, a]), $.isFunction(c.p.onRightClickRow) && c.p.onRightClickRow.call(c, $(T).attr("id"), mb, nb, a))
                    ...
                    width: d.width + "px"
                }).scroll(d.scrollGrid), $("table:first", d.bDiv).css({width: c.p.tblwidth + "px"}), $.support.tbody || 2 === $("tbody", this).length && $("tbody:gt(0)", this).remove(), c.p.multikey && ($.jgrid.msie ? $(d.bDiv).bind("selectstart", function () {
                    return !1
                }) : $(d.bDiv).bind("mousedown", function () {
                    return !1
                })), kb && $(d.bDiv).hide(), d.cDiv = document.createElement("div");
                ...
                if ($(d.cDiv).append(pb).append("<span class='ui-jqgrid-title'>" + c.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === f ? "-rtl" : "") + " ui-widget-header ui-corner-top ui-helper-clearfix"), $(d.cDiv).insertBefore(d.hDiv), c.p.toolbar[0] && (d.uDiv = document.createElement("div"), "top" === c.p.toolbar[1] ? $(d.uDiv).insertBefore(d.hDiv) : "bottom" === c.p.toolbar[1] && $(d.uDiv).insertAfter(d.hDiv), "both" === c.p.toolbar[1] ? (d.ubDiv = document.createElement("div"), $(d.uDiv).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id).insertBefore(d.hDiv), $(d.ubDiv).addClass("ui-userdata ui-state-default").attr("id", "tb_" + this.id).insertAfter(d.hDiv), kb && $(d.ubDiv).hide()) : $(d.uDiv).width(d.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), kb && $(d.uDiv).hide()), c.p.toppager && (c.p.toppager = $.jgrid.jqID(c.p.id) + "_toppager", d.topDiv = $("<div id='" + c.p.toppager + "'></div>")[0], c.p.toppager = "#" + c.p.toppager, $(d.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(d.width).insertBefore(d.hDiv), E(c.p.toppager, "_t")), c.p.footerrow && (d.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], lb = $("<div class='ui-jqgrid-hbox" + ("rtl" === f ? "-rtl" : "") + "'></div>"), $(d.sDiv).append(lb).width(d.width).insertAfter(d.hDiv), $(lb).append(fb), d.footers = $(".ui-jqgrid-ftable", d.sDiv)[0].rows[0].cells, c.p.rownumbers && (d.footers[0].className = "ui-state-default jqgrid-rownum"), kb && $(d.sDiv).hide()), lb = null, c.p.caption) {
                    ...
                    c.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", d.cDiv).click(function (a) {
                        var b, e = $.isFunction(c.p.onHeaderClick), f = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv", g = this;
                        return c.p.toolbar[0] === !0 && ("both" === c.p.toolbar[1] && (f += ", #" + $(d.ubDiv).attr("id")), f += ", #" + $(d.uDiv).attr("id")), b = $(f, "#gview_" + $.jgrid.jqID(c.p.id)).length, "visible" === c.p.gridstate ? $(f, "#gbox_" + $.jgrid.jqID(c.p.id)).slideUp("fast", function () {
                            b--, 0 === b && ($("span", g).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s"), c.p.gridstate = "hidden", $("#gbox_" + $.jgrid.jqID(c.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(c.p.id)).hide(), $(c).triggerHandler("jqGridHeaderClick", [c.p.gridstate, a]), e && (kb || c.p.onHeaderClick.call(c, c.p.gridstate, a)))
        ...
        getGridParam: function (a) {
            ...
            return this.each(function () {
                function d(a) {
                    var b = $(k.grid.bDiv)[0].clientHeight, c = $(k.grid.bDiv)[0].scrollTop, d = $(k.rows[a]).position().top, e = k.rows[a].clientHeight;
            ...
            return this.each(function () {
                var g, h, i = this;
                if (void 0 === a)e = !0, b = [], c = i.rows.length; else {
                    if (h = $(i).jqGrid("getGridRowById", a), !h)return d;
                    c = 2
                }
                for (; c > f;)e && (h = i.rows[f]), $(h).hasClass("jqgrow") && ($('td[role="gridcell"]', h).each(function (a) {
                    if (g = i.p.colModel[a].name, "cb" !== g && "subgrid" !== g && "rn" !== g)if (i.p.treeGrid === !0 && g === i.p.ExpandColumn)d[g] = $.jgrid.htmlDecode($("span:first", this).html()); else try {
                        d[g] = $.unformat.call(i, this, {rowId: h.id, colModel: i.p.colModel[a]}, a)
                    } catch (b) {
            ...
            return this.each(function () {
                ...
                if ($(b).remove(), e.p.records--, e.p.reccount--, e.updatepager(!0, !1), d = !0, e.p.multiselect && (c = $.inArray(a, e.p.selarrrow), -1 !== c && e.p.selarrrow.splice(c, 1)), e.p.selrow = e.p.multiselect && e.p.selarrrow.length > 0 ? e.p.selarrrow[e.p.selarrrow.length - 1] : null, "local" === e.p.datatype) {
                    var f = $.jgrid.stripPref(e.p.idPrefix, a), g = e.p._index[f];
            ...
            return this.each(function () {
                ...
                if (b)try {
                    if ($(this.p.colModel).each(function (c) {
                            ...
                            void 0 !== f && (k[d] = this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? $.unformat.date.call(i, f, this) : f, g = i.formatter(a, f, c, b, "edit"), e = this.title ? {title: $.jgrid.stripHtml(g)} : {}, i.p.treeGrid === !0 && d === i.p.ExpandColumn ? $("td[role='gridcell']:eq(" + c + ") > span:first", h).html(g).attr(e) : $("td[role='gridcell']:eq(" + c + ")", h).html(g).attr(e))
                        }), "local" === i.p.datatype) {
            ...
            return b && ($.isArray(b) ? (m = !0, c = "last", n = a) : (b = [b], m = !1), this.each(function () {
                ...
                for (var w = 0, x = "", y = {}, z = $.isFunction(u.p.afterInsertRow) ? !0 : !1; v > w;) {
                    ...
                    if (f.unshift(u.constructTr(a, !1, x, y, p, !1)), f[f.length] = "</tr>", 0 === u.rows.length)$("table:first", u.grid.bDiv).append(f.join("")); else switch (c) {
                        case"last":
            ...
            return this.each(function () {
                ...
                if (d.grid) {
                    ...
                    var g = "" === b ? !0 : !1, h = d.p.groupHeader && ("object" == typeof d.p.groupHeader || $.isFunction(d.p.groupHeader));
            ...
            return this.each(function () {
                ...
                if (i.grid && (isNaN(b) ? $(i.p.colModel).each(function (a) {
                    ...
                    if (k) {
                        var l = $("td:eq(" + j + ")", k);
                        if (("" !== c || f === !0) && (g = i.formatter(a, c, j, k, "edit"), h = i.p.colModel[j].title ? {title: $.jgrid.stripHtml(g)} : {}, i.p.treeGrid && $(".tree-wrap", $(l)).length > 0 ? $("span", $(l)).html(g).attr(h) : $(l).html(g).attr(h), "local" === i.p.datatype)) {
    ...
    a.jgrid.extend({
        getColProp: function (a) {
                ...
                if (!this.ftoolbar) {
                    var d, e = function () {
                        ...
                        if (b.stringResult === !0 || "local" === c.p.datatype) {
                            ...
                            }), k += "]}", a.extend(c.p.postData, {filters: k}), a.each(["searchField", "searchString", "searchOper"], function (a, b) {
                                c.p.postData.hasOwnProperty(b) && delete c.p.postData[b]
                            })
                        } else a.extend(c.p.postData, g);
                        var m;
                        c.p.searchurl && (m = c.p.url, a(c).jqGrid("setGridParam", {url: c.p.searchurl}));
                        var n = "stop" === a(c).triggerHandler("jqGridToolbarBeforeSearch") ? !0 : !1;
                        !n && a.isFunction(b.beforeSearch) && (n = b.beforeSearch.call(c)), n || a(c).jqGrid("setGridParam", {search: j}).trigger("reloadGrid", [{page: 1}]), m && a(c).jqGrid("setGridParam", {url: m}), a(c).triggerHandler("jqGridToolbarAfterSearch"), a.isFunction(b.afterSearch) && b.afterSearch.call(c)
                    }, f = function (d) {
                        var e, f = {}, g = 0;
                        d = "boolean" != typeof d ? !0 : d, a.each(c.p.colModel, function () {
                            ...
                            switch (this.searchoptions && void 0 !== this.searchoptions.defaultValue && (b = this.searchoptions.defaultValue), e = this.index || this.name, this.stype) {
                                case"select":
                                    ...
                                    break;
                                case"text":
                                    if (d.val(b || ""), void 0 !== b)f[e] = b, g++; else try {
                                        delete c.p.postData[e]
                                    } catch (i) {
                                    }
                                    break;
                        ...
                        if (c.p.resetsearch = !0, b.stringResult === !0 || "local" === c.p.datatype) {
                            ...
                            }), i += "]}", a.extend(c.p.postData, {filters: i}), a.each(["searchField", "searchString", "searchOper"], function (a, b) {
                                c.p.postData.hasOwnProperty(b) && delete c.p.postData[b]
                            })
                        } else a.extend(c.p.postData, f);
                        var k;
                        c.p.searchurl && (k = c.p.url, a(c).jqGrid("setGridParam", {url: c.p.searchurl}));
                        var l = "stop" === a(c).triggerHandler("jqGridToolbarBeforeClear") ? !0 : !1;
                        !l && a.isFunction(b.beforeClear) && (l = b.beforeClear.call(c)), l || d && a(c).jqGrid("setGridParam", {search: h}).trigger("reloadGrid", [{page: 1}]), k && a(c).jqGrid("setGridParam", {url: k}), a(c).triggerHandler("jqGridToolbarAfterClear"), a.isFunction(b.afterClear) && b.afterClear()
                    }, g = function () {
                        var b = a("tr.ui-search-toolbar", c.grid.hDiv), d = c.p.frozenColumns === !0 ? a("tr.ui-search-toolbar", c.grid.fhDiv) : !1;
                        ...
                        var q = c.p.colModel[n], r = a.extend({}, q.searchoptions);
                        ...
                        k += "</ul>", a("body").append(k), a("#sopt_menu").addClass("ui-menu ui-widget ui-widget-content ui-corner-all"), a("#sopt_menu > li > a").hover(function () {
                            ...
                            var f = a(this).attr("value"), g = a(this).attr("oper");
                            if (a(c).triggerHandler("jqGridToolbarSelectOper", [f, g, d]), a("#sopt_menu").hide(), a(d).text(g).attr("soper", f), b.autosearch === !0) {
                                var h = a(d).parent().next().children()[0];
                                (a(h).val() || "nu" === f || "nn" === f) && e()
                            }
                        })
                    }, i = a("<tr class='ui-search-toolbar' role='rowheader'></tr>");
                    a.each(c.p.colModel, function (f) {
                        var g, h, j, k, l, m = this, n = "", o = "=", p = a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-" + c.p.direction + "'></th>"), q = a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"), r = a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear'></td></tr></table>");
                                    ...
                                    if (h = this.surl || g.dataUrl)j = q, a(j).append(r), a.ajax(a.extend({
                                        ...
                                        success: function (d) {
                                            ...
                                            void 0 !== g.defaultValue && a("select", j).val(g.defaultValue), a("select", j).attr({
                                                name: m.index || m.name,
                                                id: "gs_" + m.name
                                            }), g.attr && a("select", j).attr(g.attr), a("select", j).css({width: "100%"}), a.jgrid.bindEv.call(c, a("select", j)[0], g), b.autosearch === !0 && a("select", j).change(function () {
                                                return e(), !1
                                            }), d = null
                                        }
                                        ...
                                        if (m.searchoptions ? (u = void 0 === m.searchoptions.value ? "" : m.searchoptions.value, v = void 0 === m.searchoptions.separator ? ":" : m.searchoptions.separator, w = void 0 === m.searchoptions.delimiter ? ";" : m.searchoptions.delimiter) : m.editoptions && (u = void 0 === m.editoptions.value ? "" : m.editoptions.value, v = void 0 === m.editoptions.separator ? ":" : m.editoptions.separator, w = void 0 === m.editoptions.delimiter ? ";" : m.editoptions.delimiter), u) {
                                            ...
                                            var y, z, A, B;
                                            if ("string" == typeof u)for (k = u.split(w), B = 0; B < k.length; B++)y = k[B].split(v), z = document.createElement("option"), z.value = y[0], z.innerHTML = y[1], x.appendChild(z); else if ("object" == typeof u)for (A in u)u.hasOwnProperty(A) && (z = document.createElement("option"), z.value = A, z.innerHTML = u[A], x.appendChild(z));
                        ...
                        var d = a(this).parents("tr:first"), f = parseInt(a("td.ui-search-oper", d).attr("colindex"), 10), g = a.extend({}, c.p.colModel[f].searchoptions || {}), h = g.defaultValue ? g.defaultValue : "";
                        "select" === c.p.colModel[f].stype ? h ? a("td.ui-search-input select", d).val(h) : a("td.ui-search-input select", d)[0].selectedIndex = 0 : a("td.ui-search-input input", d).val(h), b.autosearch === !0 && e()
            ...
            return void 0 === b && (b = !0), this.each(function () {
                ...
                if (k) {
                    for (a(this).unbind(".setGroupHeaders"), c = a("<tr>", {role: "rowheader"}).addClass("ui-jqgrid-labels"), f = k.headers, d = 0, e = f.length; e > d; d++) {
            ...
            return b = a.extend({useColSpanStyle: !1, groupHeaders: []}, b || {}), this.each(function () {
                ...
                var c, d, e, f, g, h, i, j, k, l, m, n, o, p = this, q = 0, r = p.p.colModel, s = r.length, t = p.grid.headers, u = a("table.ui-jqgrid-htable", p.grid.hDiv), v = u.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header"), w = u.children("thead"), x = u.find(".jqg-first-row-header");
                void 0 === x[0] ? x = a("<tr>", {
                    role: "row",
                    "aria-hidden": "true"
                ...
                for (a(p).prepend(w), e = a("<tr>", {role: "rowheader"}).addClass("ui-jqgrid-labels jqg-third-row-header"), c = 0; s > c; c++)if (g = t[c].el, h = a(g), d = r[c], i = {
                        height: "0px",
                        width: t[c].width + "px",
                        display: d.hidden ? "none" : ""
                    }, a("<th>", {role: "gridcell"}).css(i).addClass("ui-first-th-" + p.p.direction).appendTo(x), g.style.width = "", j = z(d.name, b.groupHeaders), j >= 0) {
                    for (k = b.groupHeaders[j], l = k.numberOfColumns, m = k.titleText, n = 0, j = 0; l > j && s > c + j; j++)r[c + j].hidden || n++;
                    f = a("<th>").attr({role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + p.p.direction).css({
                        height: "22px",
                        "border-top": "0 none"
                    }).html(m), n > 0 && f.attr("colspan", String(n)), p.p.headertitles && f.attr("title", f.text()), 0 === n && f.hide(), h.before(f), e.append(g), q = l - 1
                } else 0 === q ? b.useColSpanStyle ? h.attr("rowspan", "2") : (a("<th>", {role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + p.p.direction).css({
                    display: d.hidden ? "none" : "",
                    "border-top": "0 none"
            ...
            return this.each(function () {
                if (this.grid) {
                    var b = this, c = b.p.colModel, d = 0, e = c.length, f = -1, g = !1;
                    if (b.p.subGrid !== !0 && b.p.treeGrid !== !0 && b.p.cellEdit !== !0 && !b.p.sortable && !b.p.scroll) {
                        ...
                        if (f >= 0 && g) {
                            var h = b.p.caption ? a(b.grid.cDiv).outerHeight() : 0, i = a(".ui-jqgrid-htable", "#gview_" + a.jgrid.jqID(b.p.id)).height();
                            ...
                            a(j).width(1), a(b.grid.fhDiv).append(j).mousemove(function (a) {
                                ...
                                var f = a("tr.ui-jqgrid-labels:last th:eq(" + b.p.lastsort + ")", b.grid.fhDiv), g = a("tr.ui-jqgrid-labels:last th:eq(" + e + ")", b.grid.fhDiv);
    ...
    a.fn.jqm = function (d) {
        ...
        hash: {}, open: function (b, g) {
            var i = c[b], j = i.c, k = "." + j.closeClass, l = parseInt(i.w.css("z-index"));
            l = l > 0 ? l : 3e3;
            var m = a("<div></div>").css({
                height: "100%",
                width: "100%",
...
var xmlJsonClass = {
    xml2json: function (a, b) {
        ...
        var c = this.removeWhite(a), d = this.toObj(c), e = this.toJson(d, a.nodeName, "	");
        return "{\n" + b + (b ? e.replace(/\t/g, b) : e.replace(/\t|\n/g, "")) + "\n}"
    }, json2xml: function (a, b) {
        var c, d = function (a, b, c) {
            var e, f, g = "";
            if (a instanceof Array)if (0 === a.length)g += c + "<" + b + ">__EMPTY_ARRAY_</" + b + ">\n"; else for (e = 0, f = a.length; f > e; e += 1) {
                var h = c + d(a[e], b, c + "	") + "\n";
                g += h
        ...
        void 0 === d && (d = !0);
        var e = b ? '"' + b + '"' : "", f = "	", g = "\n";
        if (d || (f = "", g = ""), "[]" === a)e += b ? ":[]" : "[]"; else if (a instanceof Array) {
            var h, i, j = [];
        ...
        var b = "";
        if ("innerHTML"in a)b = a.innerHTML; else for (var c = function (a) {
            var b, d = "";
            if (1 === a.nodeType) {
...
!function (a) {
    ...
    a.fmatter = {}, a.extend(a.fmatter, {
        ...
        if (void 0 !== c.colModel.formatoptions ? (f = c.colModel.formatoptions.value, d = void 0 === c.colModel.formatoptions.separator ? ":" : c.colModel.formatoptions.separator, e = void 0 === c.colModel.formatoptions.delimiter ? ";" : c.colModel.formatoptions.delimiter) : void 0 !== c.colModel.editoptions && (f = c.colModel.editoptions.value, d = void 0 === c.colModel.editoptions.separator ? ":" : c.colModel.editoptions.separator, e = void 0 === c.colModel.editoptions.delimiter ? ";" : c.colModel.editoptions.delimiter), f) {
            var h, i = c.colModel.editoptions.multiple === !0 ? !0 : !1, j = [];
        ...
        var c = a(this).closest("tr.jqgrow"), d = c.attr("id"), e = a(this).closest("table.ui-jqgrid-btable").attr("id").replace(/_frozen([^_]*)$/, "$1"), f = a("#" + e), g = f[0], h = g.p, i = h.colModel[a.jgrid.getCellIndex(this)], j = i.frozen ? a("tr#" + d + " td:eq(" + a.jgrid.getCellIndex(this) + ") > div", f) : a(this).parent(), k = {extraparam: {}}, l = function (b, c) {
        ...
        var d, e = {keys: !1, editbutton: !0, delbutton: !0, editformbutton: !1}, f = c.rowId, g = "";
        ...
        var f, g, h = c.colModel.formatter, i = c.colModel.formatoptions || {}, j = /([\.\*\_\'\(\)\{\}\+\?\\])/g, k = c.colModel.unformat || a.fn.fmatter[h] && a.fn.fmatter[h].unformat;
        if (void 0 !== k && a.isFunction(k))f = k.call(this, a(b).text(), c, b); else if (void 0 !== h && a.fmatter.isString(h)) {
        ...
        var f = [], g = a(b).text();
        if (e === !0)return g;
        var h = a.extend({}, void 0 !== c.colModel.formatoptions ? c.colModel.formatoptions : c.colModel.editoptions), i = void 0 === h.separator ? ":" : h.separator, j = void 0 === h.delimiter ? ";" : h.delimiter;
        if (h.value) {
            ...
            if (m && (n = g.split(","), n = a.map(n, function (b) {
                ...
                for (o = 0; o < p.length; o++)if (k = p[o].split(i), k.length > 2 && (k[1] = a.map(k, function (a, b) {
                        return b > 0 ? a : void 0
                    }).join(i)), m)a.inArray(k[1], n) > -1 && (f[q] = k[0], q++); else if (a.trim(k[1]) === a.trim(g)) {
                    f[0] = k[0];
                    break
                }
    ...
    a.extend(a.jgrid, {
        showModal: function (a) {
            ...
            if (c = a.extend({jqm: !0, gb: ""}, c || {}), c.onClose) {
            ...
            var i, j = document.createElement("div"), k = this;
            ...
            if (a("a.ui-jqdialog-titlebar-close", l).click(function () {
                    ...
                    return k.hideModal("#" + a.jgrid.jqID(b.themodal), {gb: e, jqm: d.jqModal, onClose: c}), !1
            ...
            if (i && o.left && !g && (r = a(d.gbox).width() - (isNaN(d.width) ? 0 : parseInt(d.width, 10)) - 8, o.left = parseInt(o.left, 10) + parseInt(r, 10)), o.left && (o.left += "px"), a(j).css(a.extend({
                    ...
                    a(j).draggable({handle: a("#" + a.jgrid.jqID(l.id))})
                } catch (s) {
                }
            if (d.resize)if (a.fn.jqResize)a(j).append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se'></div>"), a("#" + a.jgrid.jqID(b.themodal)).jqResize(".jqResize", b.scrollelm ? "#" + a.jgrid.jqID(b.scrollelm) : !1); else try {
                a(j).resizable({handles: "se, sw", alsoResize: b.scrollelm ? "#" + a.jgrid.jqID(b.scrollelm) : !1})
            } catch (t) {
            }
            d.closeOnEscape === !0 && a(j).keydown(function (c) {
                if (27 == c.which) {
                    var e = a("#" + a.jgrid.jqID(b.themodal)).data("onClose") || d.onClose;
                    k.hideModal("#" + a.jgrid.jqID(b.themodal), {gb: d.gbox, jqm: d.jqModal, onClose: e})
                }
            })
            ...
            if (c = a.extend({
                    ...
                    jqm: !0,
                    jqM: !0
                }, c || {}), a.fn.jqm && c.jqm === !0)c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow(); else {
            ...
            var g = f.jqModal, h = this;
            a.fn.jqm && !g && (g = !1);
            var i, j = "";
            if (f.buttons.length > 0)for (i = 0; i < f.buttons.length; i++)void 0 === f.buttons[i].id && (f.buttons[i].id = "info_button_" + i), j += "<a id='" + f.buttons[i].id + "' class='fm-button ui-state-default ui-corner-all'>" + f.buttons[i].text + "</a>";
            var k = isNaN(f.dataheight) ? f.dataheight : f.dataheight + "px", l = "text-align:" + f.align + ";", m = "<div id='info_id'>";
            ...
            switch (b) {
                ...
                case"select":
                    ...
                    if (c.multiple === !0 ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, void 0 !== c.dataUrl) {
                        var n = c.name ? String(c.id).substring(0, String(c.id).length - String(c.name).length - 1) : String(c.id), o = c.postData || f.postData;
                        i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
                            ...
                            success: function (b) {
                                var c = [], d = this.elem, e = this.vl, f = a.extend({}, this.options), h = f.multiple === !0, j = a.isFunction(f.buildSelect) ? f.buildSelect.call(i, b) : b;
                        ...
                        var q, r, s, t = void 0 === c.separator ? ":" : c.separator, u = void 0 === c.delimiter ? ";" : c.delimiter;
                        if ("string" == typeof c.value)for (q = c.value.split(u), p = 0; p < q.length; p++)r = q[p].split(t), r.length > 2 && (r[1] = a.map(r, function (a, b) {
                            return b > 0 ? a : void 0
                        }).join(t)), s = document.createElement("option"), s.setAttribute("role", "option"), s.value = r[0], s.innerHTML = r[1], h.appendChild(s), l || a.trim(r[0]) !== a.trim(d) && a.trim(r[1]) !== a.trim(d) || (s.selected = "selected"), l && (a.inArray(a.trim(r[1]), m) > -1 || a.inArray(a.trim(r[0]), m) > -1) && (s.selected = "selected"); else if ("object" == typeof c.value) {
                            var v, w = c.value;
                ...
                case"button":
                    var x;
                    x = "button" === b ? "button" : "textbox", h = document.createElement("input"), h.type = b, h.value = d, g(h, c), "button" !== b && (e ? c.size || a(h).css({width: "98%"}) : c.size || (c.size = 20)), a(h).attr("role", x);
                    break;
                case"image":
                case"file":
                ...
                case"custom":
                    ...
                    try {
                        ...
                        if (!y)throw"e2";
                        y = a(y).addClass("customelement").attr({id: c.id, name: c.name}), a(h).empty().append(y)
                    } catch (z) {
            ...
            var f, g, h, i, j, k = this, l = k.p.colModel;
            ...
            } else c >= 0 && (f = l[c].editrules); else f = d, h = void 0 === e ? "_" : e;
            if (f) {
            ...
            if (!this.filter) {
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    this.onchange = function () {
                        ...
                        var d, f = this, g = a("<table class='group ui-widget ui-widget-content' style='border:0px none;'><tbody></tbody></table>"), h = "left";
                        ...
                        var d, h, i, j, k, l = this, m = g(), n = a("<tr></tr>"), o = "";
                        n.append("<td class='first'></td>");
                        var p = a("<td class='columns'></td>");
                        n.append(p);
                        var q, r = a("<select></select>"), s = [];
                        p.append(r), r.bind("change", function () {
                            for (b.field = a(r).val(), i = a(this).parents("tr:first"), d = 0; d < l.p.columns.length; d++)if (l.p.columns[d].name === b.field) {
                                j = l.p.columns[d];
                                break
                            }
                            if (j) {
                        ...
                        for (d = 0; d < l.p.columns.length; d++) {
                            var u = void 0 === l.p.columns[d].search ? !0 : l.p.columns[d].search, v = l.p.columns[d].hidden === !0, w = l.p.columns[d].searchoptions.searchhidden === !0;
                        ...
                        var c, d, f, g, i = "", j = "", k = ["int", "integer", "float", "number", "currency"];
    ...
    a.jgrid.extend({
        searchGrid: function (b) {
            return b = a.extend(!0, {
                ...
                var d = this;
                if (d.grid) {
                    var e = "fbox_" + d.p.id, f = !0, g = !0, h = {
                        themodal: "searchmod" + e,
                        modalhead: "searchhd" + e,
                        modalcontent: "searchcnt" + e,
                        scrollelm: e
                    }, i = d.p.postData[b.sFilter];
                    if ("string" == typeof i && (i = a.jgrid.parse(i)), b.recreateFilter === !0 && a("#" + a.jgrid.jqID(h.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(h.themodal))[0])c(a("#fbox_" + a.jgrid.jqID(+d.p.id))); else {
                        var j = a("<div><div id='" + e + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" + a.jgrid.jqID(d.p.id)), k = "left", l = "";
                        "rtl" === d.p.direction && (k = "right", l = " style='text-align:left'", j.attr("dir", "rtl"));
                        var m, n, o = a.extend([], d.p.colModel), p = "<a id='" + e + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + b.Find + "</a>", q = "<a id='" + e + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" + b.Reset + "</a>", r = "", s = "", t = !1, u = -1;
                        ...
                        t = !1, b.tmplNames && b.tmplNames.length && (t = !0, s = b.tmplLabel, s += "<select class='ui-template'>", s += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a, b) {
                        ...
                        }), b.multipleGroup === !0 && (b.multipleSearch = !0), a(d).triggerHandler("jqGridFilterInitialize", [a("#" + e)]), a.isFunction(b.onInitializeSearch) && b.onInitializeSearch.call(d, a("#" + e)), b.gbox = "#gbox_" + e, b.layer ? a.jgrid.createModal(h, j, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "#" + a.jgrid.jqID(b.layer), {position: "relative"}) : a.jgrid.createModal(h, j, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0]), (b.searchOnEnter || b.closeOnEscape) && a("#" + a.jgrid.jqID(h.themodal)).keydown(function (c) {
                            var d = a(c.target);
                            ...
                            return d.p.search = !0, a.extend(d.p.postData, j), g = a(d).triggerHandler("jqGridFilterSearch"), void 0 === g && (g = !0), g && a.isFunction(b.onSearch) && (g = b.onSearch.call(d, d.p.filters)), g !== !1 && a(d).trigger("reloadGrid", [{page: 1}]), b.closeAfterSearch && a.jgrid.hideModal("#" + a.jgrid.jqID(h.themodal), {
                            ...
                            var c = {}, f = a("#" + e);
                            return d.p.search = !1, d.p.resetsearch = !0, b.multipleSearch === !1 ? c[b.sField] = c[b.sValue] = c[b.sOper] = "" : c[b.sFilter] = "", f[0].resetFilter(), t && a(".ui-template", j).val("default"), a.extend(d.p.postData, c), g = a(d).triggerHandler("jqGridFilterReset"), void 0 === g && (g = !0), g && a.isFunction(b.onReset) && (g = b.onReset.call(d)), g !== !1 && a(d).trigger("reloadGrid", [{page: 1}]), b.closeAfterReset && a.jgrid.hideModal("#" + a.jgrid.jqID(h.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(d.p.id),
                                jqm: b.jqModal,
                                onClose: b.onClose
                            }), !1
            ...
            return d = a.extend(!0, {
                    ...
                    return a(v + " > tbody > tr > td > .FormElement").each(function () {
                        ...
                        if (b.length) {
                            ...
                            switch (a(this).get(0).type) {
                                case"checkbox":
                                    if (a(this).is(":checked"))p[this.name] = a(this).val(); else {
                                ...
                                case"select-multiple":
                                    p[this.name] = a(this).val(), p[this.name] = p[this.name] ? p[this.name].join(",") : "";
                                    var f = [];
                ...
                function f(c, d, e, f) {
                    var g, h, i, j, k, l, m, n = 0, p = [], q = !1, r = "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>", s = "";
                    for (m = 1; f >= m; m++)s += r;
                    if ("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (m) {
                            if (g = this.name, h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, k = h ? "style='display:none'" : "", "cb" !== g && "subgrid" !== g && this.editable === !0 && "rn" !== g) {
                                if (q === !1)j = ""; else if (g === d.p.ExpandColumn && d.p.treeGrid === !0)j = a("td[role='gridcell']:eq(" + m + ")", d.rows[q]).text();
                                else {
                                    try {
                                ...
                                var u = a.extend({}, this.editoptions || {}, {
                                    ...
                                    rowabove: !1,
                                    rowcontent: ""
                                }, this.formoptions || {}), w = parseInt(v.rowpos, 10) || n + 1, x = parseInt(2 * (parseInt(v.colpos, 10) || 1), 10);
                ...
                function i() {
                    var c, e, f, i, j, k, l = [!0, "", ""], m = {}, n = o.p.prmNames, q = a(o).triggerHandler("jqGridAddEditBeforeCheckValues", [a("#" + t), r]);
                    ...
                    if (h(), l[0] && (m = a(o).triggerHandler("jqGridAddEditClickSubmit", [b[o.p.id], p, r]), void 0 === m && a.isFunction(b[o.p.id].onclickSubmit) && (m = b[o.p.id].onclickSubmit.call(o, b[o.p.id], p, r) || {}), l = a(o).triggerHandler("jqGridAddEditBeforeSubmit", [p, a("#" + t), r]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[o.p.id].beforeSubmit) && (l = b[o.p.id].beforeSubmit.call(o, p, a("#" + t), r))), l[0] && !b[o.p.id].processing) {
                        ...
                        var y = a.extend({
                            ...
                            complete: function (h, i) {
                                var k;
                                if (p[e] = o.p.idPrefix + p[e], h.status >= 300 && 304 !== h.status ? (l[0] = !1, l[1] = a(o).triggerHandler("jqGridAddEditErrorTextFormat", [h, r]), l[1] = a.isFunction(b[o.p.id].errorTextFormat) ? b[o.p.id].errorTextFormat.call(o, h, r) : i + " Status: '" + h.statusText + "'. Error code: " + h.status) : (l = a(o).triggerHandler("jqGridAddEditAfterSubmit", [h, p, r]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[o.p.id].afterSubmit) && (l = b[o.p.id].afterSubmit.call(o, h, p, r))), l[0] === !1)a("#FormError>td", v).html(l[1]), a("#FormError", v).show(); else if (o.p.autoencode && a.each(p, function (b, c) {
                ...
                function n() {
                    var b = a(o).jqGrid("getDataIDs"), c = a("#id_g", v).val(), d = a.inArray(c, b);
                    return [d, b]
                }

                var o = this;
                if (o.grid && c) {
                    var p, q, r, s = o.p.id, t = "FrmGrid_" + s, u = "TblGrid_" + s, v = "#" + a.jgrid.jqID(u), w = {
                        themodal: "editmod" + s,
                        modalhead: "edithd" + s,
                        modalcontent: "editcnt" + s,
                        scrollelm: t
                    }, x = a.isFunction(b[o.p.id].beforeShowForm) ? b[o.p.id].beforeShowForm : !1, y = a.isFunction(b[o.p.id].afterShowForm) ? b[o.p.id].afterShowForm : !1, z = a.isFunction(b[o.p.id].beforeInitData) ? b[o.p.id].beforeInitData : !1, A = a.isFunction(b[o.p.id].onInitializeForm) ? b[o.p.id].onInitializeForm : !1, B = !0, C = 1, D = 0;
                    ...
                    var F = isNaN(b[a(this)[0].p.id].dataheight) ? b[a(this)[0].p.id].dataheight : b[a(this)[0].p.id].dataheight + "px", G = isNaN(b[a(this)[0].p.id].datawidth) ? b[a(this)[0].p.id].datawidth : b[a(this)[0].p.id].datawidth + "px", H = a("<form name='FormPost' id='" + t + "' class='FormGrid' onSubmit='return false;' style='width:" + G + ";overflow:auto;position:relative;height:" + F + ";'></form>").data("disabled", !1), I = a("<table id='" + u + "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>");
                    if (B = a(o).triggerHandler("jqGridAddEditBeforeInitData", [a("#" + t), r]), void 0 === B && (B = !0), B && z && (B = z.call(o, a("#" + t), r)), B !== !1) {
                        ...
                        var K = "rtl" === o.p.direction ? !0 : !1, L = K ? "nData" : "pData", M = K ? "pData" : "nData";
                        f(c, o, I, C);
                        var N = "<a id='" + L + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>", O = "<a id='" + M + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>", P = "<a id='sData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>", Q = "<a id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>", R = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + u + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (K ? O + N : N + O) + "</td><td class='EditButton'>" + P + Q + "</td></tr>";
            ...
            return d = a.extend(!0, {
                ...
                function f(b, c, e, f) {
                    var g, h, i, j, k, l, m, n, o, p = 0, q = [], r = !1, s = "<td class='CaptionTD form-view-label ui-widget-content' width='" + d.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", t = "", u = "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>", v = ["integer", "number", "currency"], w = 0, x = 0;
                    ...
                    if (a(c.p.colModel).each(function () {
                            ...
                            if (g = this.name, n = !1, h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, k = h ? "style='display:none'" : "", o = "boolean" != typeof this.viewable ? !0 : this.viewable, "cb" !== g && "subgrid" !== g && "rn" !== g && o) {
                                ...
                                var d = a.extend({}, {
                                    rowabove: !1,
                                    rowcontent: ""
                                }, this.formoptions || {}), l = parseInt(d.rowpos, 10) || p + 1, s = parseInt(2 * (parseInt(d.colpos, 10) || 1), 10);
                                if (d.rowabove) {
                ...
                function i() {
                    var b = a(j).jqGrid("getDataIDs"), c = a("#id_g", "#" + m).val(), d = a.inArray(c, b);
                    return [d, b]
                }

                var j = this;
                if (j.grid && c) {
                    var k = j.p.id, l = "ViewGrid_" + a.jgrid.jqID(k), m = "ViewTbl_" + a.jgrid.jqID(k), n = "ViewGrid_" + k, o = "ViewTbl_" + k, p = {
                        themodal: "viewmod" + k,
                        modalhead: "viewhd" + k,
                        modalcontent: "viewcnt" + k,
                        scrollelm: l
                    }, q = a.isFunction(b[j.p.id].beforeInitData) ? b[j.p.id].beforeInitData : !1, r = !0, s = 1, t = 0;
                    d.recreateForm || a(j).data("viewProp") && a.extend(b[a(this)[0].p.id], a(j).data("viewProp"));
                    var u = isNaN(b[a(this)[0].p.id].dataheight) ? b[a(this)[0].p.id].dataheight : b[a(this)[0].p.id].dataheight + "px", v = isNaN(b[a(this)[0].p.id].datawidth) ? b[a(this)[0].p.id].datawidth : b[a(this)[0].p.id].datawidth + "px", w = a("<form name='FormPost' id='" + n + "' class='FormGrid' style='width:" + v + ";overflow:auto;position:relative;height:" + u + ";'></form>"), x = a("<table id='" + o + "' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
            ...
            return d = a.extend(!0, {
                ...
                var e = this;
                if (e.grid && c) {
                    var f, g, h, i, j = a.isFunction(b[e.p.id].beforeShowForm), k = a.isFunction(b[e.p.id].afterShowForm), l = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1, m = e.p.id, n = {}, o = !0, p = "DelTbl_" + a.jgrid.jqID(m), q = "DelTbl_" + m, r = {
                        themodal: "delmod" + m,
                        modalhead: "delhd" + m,
                    ...
                    if (a.isArray(c) && (c = c.join()), void 0 !== a("#" + a.jgrid.jqID(r.themodal))[0]) {
                        ...
                        var s = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight : b[e.p.id].dataheight + "px", t = isNaN(d.datawidth) ? d.datawidth : d.datawidth + "px", u = "<div id='" + q + "' class='formdata' style='width:" + t + ";overflow:auto;position:relative;height:" + s + ";'>";
                        ...
                        var v = "<a id='dData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>", w = "<a id='eData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>";
                        ...
                        a(".fm-button", "#" + p + "_2").hover(function () {
                            ...
                            var c, j = [!0, ""], k = a("#DelData>td", "#" + p).text();
                            if (n = {}, a.isFunction(b[e.p.id].onclickSubmit) && (n = b[e.p.id].onclickSubmit.call(e, b[e.p.id], k) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (j = b[e.p.id].beforeSubmit.call(e, k)), j[0] && !b[e.p.id].processing) {
                                ...
                                var l = a.extend({
                                    ...
                                    complete: function (c, g) {
                                        var h;
                                        if (c.status >= 300 && 304 !== c.status ? (j[0] = !1, j[1] = a.isFunction(b[e.p.id].errorTextFormat) ? b[e.p.id].errorTextFormat.call(e, c) : g + " Status: '" + c.statusText + "'. Error code: " + c.status) : a.isFunction(b[e.p.id].afterSubmit) && (j = b[e.p.id].afterSubmit.call(e, c, f)), j[0] === !1)a("#DelError>td", "#" + p).html(j[1]), a("#DelError", "#" + p).show(); else {
                                            if (b[e.p.id].reloadAfterSubmit && "local" !== e.p.datatype)a(e).trigger("reloadGrid");
                                                ...
                                                } else for (h = 0; h < k.length; h++)a(e).jqGrid("delRowData", e.p.idPrefix + k[h]);
            ...
            return c = a.extend({
                ...
                if (!this.nav) {
                    ...
                    if (l.grid && "string" == typeof b) {
                        ...
                        var m, n = 1, o = function () {
                            a(this).hasClass("ui-state-disabled") || a(this).addClass("ui-state-hover")
                        }, p = function () {
                            a(this).removeClass("ui-state-hover")
                        };
                        for (c.cloneToTop && l.p.toppager && (n = 2), m = 0; n > m; m++) {
                            var q, r, s, t = a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"), u = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>";
                            0 === m ? (r = b, s = l.p.id, r === l.p.toppager && (s += "_top", n = 1)) : (r = l.p.toppager, s = l.p.id + "_top"), "rtl" === l.p.direction && a(t).attr("dir", "rtl").css("float", "right"), c.add && (e = e || {}, q = a("<td class='ui-pg-button ui-corner-all'></td>"), a(q).append("<div class='ui-pg-div'><span class='ui-icon " + c.addicon + "'></span>" + c.addtext + "</div>"), a("tr", t).append(q), a(q, t).attr({
                                ...
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    ...
                                    switch (c.refreshstate) {
                                        case"firstpage":
                                            a(l).trigger("reloadGrid", [{page: 1}]);
                                            break;
                                        case"current":
                                            a(l).trigger("reloadGrid", [{current: !0}])
                                    }
    ...
    a.jgrid.inlineEdit = a.jgrid.inlineEdit || {}, a.jgrid.extend({
        editRow: function (b, c, d, e, f, g, h, i, j) {
            ...
            return "object" === a.type(l[0]) ? k = l[0] : (void 0 !== c && (k.keys = c), a.isFunction(d) && (k.oneditfunc = d), a.isFunction(e) && (k.successfunc = e), void 0 !== f && (k.url = f), void 0 !== g && (k.extraparam = g), a.isFunction(h) && (k.aftersavefunc = h), a.isFunction(i) && (k.errorfunc = i), a.isFunction(j) && (k.afterrestorefunc = j)), k = a.extend(!0, {
                ...
                var c, d, e, f, g, h, i = this, j = 0, l = null, m = {};
                i.grid && (f = a(i).jqGrid("getInd", b, !0), f !== !1 && (h = a.isFunction(k.beforeEditRow) ? k.beforeEditRow.call(i, k, b) : void 0, void 0 === h && (h = !0), h && (e = a(f).attr("editable") || "0", "0" !== e || a(f).hasClass("not-editable-row") || (g = i.p.colModel, a('td[role="gridcell"]', f).each(function (e) {
                    ...
                    if ("cb" !== c && "subgrid" !== c && "rn" !== c && (i.p.autoencode && (d = a.jgrid.htmlDecode(d)), m[c] = d, g[e].editable === !0)) {
                        ...
                        var k = a.extend({}, g[e].editoptions || {}, {id: b + "_" + c, name: c});
            ...
            var k, l, m, n, o, p = !1, q = this[0], r = {}, s = {}, t = {};
            if (!q.grid)return p;
            ...
            if (void 0 === u && (u = !0), u) {
                if (l = a(o).attr("editable"), j.url = j.url || q.p.editurl, "1" === l) {
                    ...
                    if (a('td[role="gridcell"]', o).each(function (b) {
                                ...
                                switch (v.edittype) {
                                    ...
                                    case"select":
                                        if (v.editoptions.multiple) {
                                            ...
                                            r[k] = a(d).val(), r[k] = r[k] ? r[k].join(",") : "", a("select option:selected", this).each(function (b, c) {
                                                e[b] = a(c).text()
                                            }), s[k] = e.join(",")
                        ...
                        try {
                            var w = a(q).jqGrid("getGridRowById", b), x = a.jgrid.findPos(w);
                    ...
                    if ("clientArray" === j.url) {
                        ...
                        for (a(o).attr("editable", "0"), F = 0; F < q.p.savedRow.length; F++)if (String(q.p.savedRow[F].id) === String(B)) {
                            m = F;
                            break
                        }
                            ...
                            if (a("#lui_" + a.jgrid.jqID(q.p.id)).hide(), "success" === d) {
                                ...
                                if (e = a(q).triggerHandler("jqGridInlineSuccessSaveRow", [c, b, j]), a.isArray(e) || (e = [!0, r]), e[0] && a.isFunction(j.successfunc) && (e = j.successfunc.call(q, c)), a.isArray(e) ? (g = e[0], r = e[1] || r) : g = e, g === !0) {
                                    for (q.p.autoencode && a.each(r, function (b, c) {
                                        r[b] = a.jgrid.htmlDecode(c)
                                    }), r = a.extend({}, r, s), a(q).jqGrid("setRowData", b, r), a(o).attr("editable", "0"), f = 0; f < q.p.savedRow.length; f++)if (String(q.p.savedRow[f].id) === String(b)) {
                                        m = f;
                                        break
                                    }
                        ...
                        error: function (c, d, e) {
                            if (a("#lui_" + a.jgrid.jqID(q.p.id)).hide(), a(q).triggerHandler("jqGridInlineErrorSaveRow", [b, c, d, e, j]), a.isFunction(j.errorfunc))j.errorfunc.call(q, b, c, d, e); else {
                                var f = c.responseText || c.statusText;
                                try {
                                    a.jgrid.info_dialog(a.jgrid.errors.errcap, '<div class="ui-state-error">' + f + "</div>", a.jgrid.edit.bClose, {buttonalign: "right"})
                                } catch (g) {
                                    alert(f)
                                }
                            }
            ...
            return c = a.extend(!0, {
                ...
                if (this.grid) {
                    var d, e = this, f = a.jgrid.jqID(e.p.id);
                    ...
                    c.add && a(e).jqGrid("navButtonAdd", b, {
                        ...
                        onClickButton: function () {
                            ...
                            if (b) {
                                var d = e.p.prmNames, g = d.oper, h = c.editParams;
                            ...
                            } else a.jgrid.viewModal("#alertmod", {gbox: "#gbox_" + f, jqm: !0}), a("#jqg_alrt").focus()
                        }
                        ...
                        id: e.p.id + "_ilcancel",
                        onClickButton: function () {
                            var b = e.p.savedRow[0].id, d = c.editParams;
            ...
            return this.each(function () {
                ...
                if (e.grid && e.p.cellEdit === !0) {
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        var f, g, h = a("td:eq(" + c + ")", e.rows[b]), i = e.p.colModel[c], j = i.name, k = a.jgrid.jqID(j);
                        switch (i.edittype) {
                            case"select":
                                if (i.editoptions.multiple) {
                                    var l = a("#" + b + "_" + k, e.rows[b]), m = [];
            ...
            return this.each(function () {
                ...
                if (d.grid) {
                    var e, f, g, h, i, j = function (b, c, e) {
                        ...
                        var e, f, g, h = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), i = a("<tr></tr>");
                        ...
                        a(h).append(i), b && (g = d.p.xmlReader.subgrid, a(g.root + " " + g.row, b).each(function () {
                            if (i = a("<tr class='ui-widget-content ui-subtblcell'></tr>"), g.repeatitems === !0)a(g.cell, this).each(function (b) {
                                ...
                                if (b)for (f = 0; f < b.length; f++)j(i, a(b[f], this).text() || "&#160;", f)
                            }
                            a(h).append(i)
                        }));
                        ...
                        var e, f, g, h, i, k, l = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), m = a("<tr></tr>");
                        ...
                        if (a(l).append(m), b && (i = d.p.jsonReader.subgrid, f = a.jgrid.getAccessor(b, i.root), void 0 !== f))for (g = 0; g < f.length; g++) {
                            if (h = f[g], m = a("<tr class='ui-widget-content ui-subtblcell'></tr>"), i.repeatitems === !0)for (i.cell && (h = h[i.cell]), k = 0; k < h.length; k++)j(m, h[k] || "&#160;", k); else {
                                var n = d.p.subGridModel[0].mapping || d.p.subGridModel[0].name;
                                if (n.length)for (k = 0; k < n.length; k++)j(m, h[n[k]] || "&#160;", k)
                            }
                            a(l).append(m)
                        }
                        ...
                        var c, e, f, g;
                        if (c = a(b).attr("id"), e = {nd_: (new Date).getTime()}, e[d.p.prmNames.subgridid] = c, !d.p.subGridModel[0])return !1;
    ...
    a.jgrid.extend({
        setTreeNode: function (b, c) {
            return this.each(function () {
                var d = this;
                if (d.grid && d.p.treeGrid)for (var e, f, g, h, i, j, k, l, m = d.p.expColInd, n = d.p.treeReader.expanded_field, o = d.p.treeReader.leaf_field, p = d.p.treeReader.level_field, q = d.p.treeReader.icon_field, r = d.p.treeReader.loaded; c > b;) {
                    var s, t = a.jgrid.stripPref(d.p.idPrefix, d.rows[b].id), u = d.p._index[t];
            ...
            return this.each(function () {
                var b, c, d, e, f = this, g = 0, h = !1, i = [];
                if (f.p.treeGrid) {
                    f.p.treedatatype || a.extend(f.p, {treedatatype: f.p.datatype}), f.p.subGrid = !1, f.p.altRows = !1, f.p.pgbuttons = !1, f.p.pginput = !1, f.p.gridview = !0, null === f.p.rowTotal && (f.p.rowNum = 1e4), f.p.multiselect = !1, f.p.rowList = [], f.p.expColInd = 0, b = "ui-icon-triangle-1-" + ("rtl" === f.p.direction ? "w" : "e"), f.p.treeIcons = a.extend({
                        plus: b,
            ...
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    var d = a(c).jqGrid("getNodeChildren", b), e = c.p.treeReader.expanded_field;
                    a(d).each(function () {
            ...
            return this.each(function () {
                ...
                if (e.grid && e.p.treeGrid)switch (e.p.treeGridModel) {
                    case"nested":
                        var f = e.p.treeReader.left_field, g = e.p.treeReader.right_field, h = e.p.treeReader.level_field, i = parseInt(b[f], 10), j = parseInt(b[g], 10), k = parseInt(b[h], 10);
                        a(this.p.data).each(function () {
                    ...
                    case"adjacency":
                        if (b) {
                            c.push(b);
                            var l = e.p.treeReader.parent_id_field, m = e.p.localReader.id;
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (!b[c]) {
                        var i = a.jgrid.getAccessor(b, this.p.localReader.id), j = a("#" + this.p.idPrefix + a.jgrid.jqID(i), this.grid.bDiv)[0], k = this.p._index[i];
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (b[c]) {
                        b[c] = !1;
                        var d = a.jgrid.getAccessor(b, this.p.localReader.id), e = a("#" + this.p.idPrefix + a.jgrid.jqID(d), this.grid.bDiv)[0];
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var f, g, h, i, j, k = [], l = this, m = a(this).jqGrid("getRootNodes");
                ...
                if (h.grid && h.p.treeGrid) {
                    ...
                    if (void 0 !== l) {
                        ...
                        if ("nested" === h.p.treeGridModel) {
                            if (f = a.jgrid.from(h.p.data).greater(j, d, {stype: "integer"}).select(), f.length)for (g in f)f.hasOwnProperty(g) && (f[g][j] = parseInt(f[g][j], 10) - e);
                            if (f = a.jgrid.from(h.p.data).greater(k, d, {stype: "integer"}).select(), f.length)for (g in f)f.hasOwnProperty(g) && (f[g][k] = parseInt(f[g][k], 10) - e)
                        }
                    }
                }
            })
            ...
            if (d) {
                ...
                if (l = k + 1, void 0 === d[o] && (d[o] = !1), void 0 === d[u] && (d[u] = !1), d[q] = j, void 0 === d[p] && (d[p] = !0), "adjacency" === f.p.treeGridModel && (d[r] = c), "nested" === f.p.treeGridModel) {
                    var z, A, B;
                    if (null !== c) {
                        if (n = parseInt(i[t], 10), z = a.jgrid.from(f.p.data), z = z.greaterOrEquals(t, n, {stype: "integer"}), A = z.select(), A.length)for (B in A)A.hasOwnProperty(B) && (A[B][s] = A[B][s] > n ? parseInt(A[B][s], 10) + 2 : A[B][s], A[B][t] = A[B][t] >= n ? parseInt(A[B][t], 10) + 2 : A[B][t]);
                        d[s] = n, d[t] = n + 1
                    } else {
                        if (n = parseInt(a(f).jqGrid("getCol", t, !1, "max"), 10), A = a.jgrid.from(f.p.data).greater(s, n, {stype: "integer"}).select(), A.length)for (B in A)A.hasOwnProperty(B) && (A[B][s] = parseInt(A[B][s], 10) + 2);
                        if (A = a.jgrid.from(f.p.data).greater(t, n, {stype: "integer"}).select(), A.length)for (B in A)A.hasOwnProperty(B) && (A[B][t] = parseInt(A[B][t], 10) + 2);
                        d[s] = n + 1, d[t] = n + 2
                    }
                }
    ...
    a.extend(a.jgrid, {
        template: function (b) {
            var c, d = a.makeArray(arguments).slice(1), e = d.length;
            return null == b && (b = ""), b.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g, function (b, f) {
                if (!isNaN(parseInt(f, 10)))return d[parseInt(f, 10)];
                for (c = 0; e > c; c++)if (a.isArray(d[c]))for (var g = d[c], h = g.length; h--;)if (f === g[h].nm)return g[h].v
            })
        }
    }), a.jgrid.extend({
        groupingSetup: function () {
            return this.each(function () {
                var b, c, d, e = this, f = e.p.colModel, g = e.p.groupingView;
                if (null === g || "object" != typeof g && !a.isFunction(g))e.p.grouping = !1; else if (g.groupField.length) {
            ...
            return this.each(function () {
                var d, e, f, g, h, i = this.p.groupingView, j = this, k = i.groupField.length, l = 0;
            ...
            return this.each(function () {
                ...
                }, p = !1, q = c.p.frozenColumns ? c.p.id + "_frozen" : !1, r = q ? a("#" + a.jgrid.jqID(b), "#" + a.jgrid.jqID(q)) : !1, s = r && r.length ? r[0].nextSibling : null;
                if (n.hasClass(j)) {
                    ...
                    } else if (m)for (; m && (g = o(m.className), !(void 0 !== g && f >= g));)a(m).hide(), m = m.nextSibling, q && (a(s).hide(), s = s.nextSibling);
            ...
            return this.each(function () {
                ...
                var h, i, j, k = this, l = k.p.groupingView, m = "", n = "", o = l.groupCollapse ? l.plusicon : l.minusicon, p = [], q = l.groupField.length;
                ...
                var r = 0, s = a.makeArray(l.groupSummary);
                s.reverse(), a.each(l.groups, function (f, t) {
                    ...
                    var v = q - 1 === t.idx;
                    if (v) {
                        var w, x, y = l.groups[f + 1], z = 0, A = t.startRow, B = void 0 !== y ? l.groups[f + 1].startRow : b.length;
        ...
        jqGridImport: function (b) {
            return b = a.extend({
                ...
                var c = this, d = function (b, d) {
                    var e, f, g, h = a(d.xmlGrid.config, b)[0], i = a(d.xmlGrid.data, b)[0];
                    if (xmlJsonClass.xml2json && a.jgrid.parse) {
                        ...
                        if (i) {
                            ...
                            e.grid.datatype = "xmlstring", e.grid.datastr = b, a(c).jqGrid(f).jqGrid("setGridParam", {datatype: j})
                        } else a(c).jqGrid(f);
                        e = null, f = null
                    ...
                    if (b && "string" == typeof b) {
                        ...
                        e && (a.jgrid.useJSON = !0);
                        var g = f[d.jsonGrid.config], h = f[d.jsonGrid.data];
                        if (h) {
                            var i = g.datatype;
                            g.datatype = "jsonstring", g.datastr = h, a(c).jqGrid(g).jqGrid("setGridParam", {datatype: i})
                        } else a(c).jqGrid(g)
                    }
                };
                switch (b.imptype) {
            ...
            b = a.extend({exptype: "xmlstring", root: "grid", ident: "	"}, b || {});
            var c = null;
            return this.each(function () {
                if (this.grid) {
    ...
    $.jgrid.extend({
        sortableColumns: function (a) {
            ...
            function b(a, b, c) {
                if (b >= 0) {
                    var d = a.slice(), e = d.splice(b, Math.max(a.length - b, b));
            ...
            if (!$("#colchooser_" + $.jgrid.jqID(d[0].p.id)).length) {
                var e = $('<div id="colchooser_' + d[0].p.id + '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'), f = $("select", e);
                if (a = $.extend({
                        width: 420, height: 240, classname: null, done: function (a) {
                ...
                var g = d.jqGrid("getGridParam", "colModel"), h = d.jqGrid("getGridParam", "colNames"), i = {}, j = [];
            ...
            return this.each(function () {
                ...
                if ($t.grid && $.fn.resizable) {
                    if (opts = $.extend({}, opts || {}), opts.alsoResize ? (opts._alsoResize_ = opts.alsoResize, delete opts.alsoResize) : opts._alsoResize_ = !1, opts.stop && $.isFunction(opts.stop) ? (opts._stop_ = opts.stop, delete opts.stop) : opts._stop_ = !1, opts.stop = function (a, b) {
                            $($t).jqGrid("setGridParam", {height: $("#gview_" + gID + " .ui-jqgrid-bdiv").height()}), $($t).jqGrid("setGridWidth", b.size.width, opts.shrinkToFit), opts._stop_ && opts._stop_.call($t, a, b)
                        }, opts._alsoResize_) {
            ...
            return this.each(function () {
                ...
                function n(b, c, d, e) {
                    ...
                    for (j = a.isArray(d) ? d.length : 1, h = [], h.root = 0, i = 0; j > i; i++) {
                        var l, n = [];
                        for (f = 0; k > f; f++) {
                            if (null == d)g = a.trim(c[f].member) + "_" + c[f].aggregator, l = g; else {
                                l = d[i].replace(/\s+/g, "");
                                try {
                ...
                function o(a) {
                    ...
                    for (d in a)if (a.hasOwnProperty(d)) {
                        if ("object" != typeof a[d]) {
                            if ("level" === d) {
                                if (void 0 === K[a.level] && (K[a.level] = "", a.level > 0 && "_r_Totals" !== a.text && (j[a.level - 1] = {
                                    ...
                                    j[a.level - 1].groupHeaders.push({titleText: a.text});
                                    var h = j[a.level - 1].groupHeaders.length, i = 1 === h ? M : L + (h - 1) * u;
                                    j[a.level - 1].groupHeaders[h - 1].startColumnName = e[i].name, j[a.level - 1].groupHeaders[h - 1].numberOfColumns = e.length - i, L = e.length
                                }
                                K[a.level] = a.text
                            }
                            if (a.level === t && "level" === d && t > 0)if (u > 1) {
                                var l = 1;
                        ...
                        if (null != a[d] && "object" == typeof a[d] && o(a[d]), "level" === d && a.level > 0) {
                            ...
                            for (b in a.fields) {
                                g = {};
                                for (f in k.aggregates[c])if (k.aggregates[c].hasOwnProperty(f))switch (f) {
                                    case"member":
                                    case"label":
                                    case"aggregator":
                                        break;
                ...
                var p, q, r, s, t, u, v, w, x = c.length, y = 0;
                if (k.rowTotals && k.yDimension.length > 0) {
                    var z = k.yDimension[0].dataName;
                    k.yDimension.splice(0, 0, {dataName: z}), k.yDimension[0].converter = function () {
                        return "_r_Totals"
                    }
                }
                ...
                for (var B = s - 1, C = {}; x > y;) {
                    ...
                    for (G in h) {
                        if (0 === H)C.children && void 0 !== C.children || (C = {
                            ...
                            for (J = null, r = 0; r < I.length; r++)if (I[r].text === G) {
                                J = I[r];
                                break
                            }
                ...
                var K = [], L = e.length, M = L;
                t > 0 && (j[t - 1] = {useColSpanStyle: !1, groupHeaders: []}), o(C, 0);
                var N;
                if (k.colTotals)for (var O = f.length; O--;)for (r = s; r < e.length; r++)N = e[r].name, g[N] ? g[N] += parseFloat(f[O][N] || 0) : g[N] = parseFloat(f[O][N] || 0);
                if (B > 0)for (r = 0; B > r; r++)i.groupingView.groupField[r] = e[r].name, i.groupingView.groupSummary[r] = k.groupSummary, i.groupingView.groupSummaryPos[r] = k.groupSummaryPos; else i.grouping = !1;
                i.sortname = e[B].name, i.groupingView.hideFirstGroupCol = !0
            }), {colModel: e, rows: f, groupOptions: i, groupHeaders: j, summary: g}
        }, jqPivot: function (b, c, d, e) {
            return this.each(function () {
                function f(b) {
                    var e, f = jQuery(g).jqGrid("pivotSetup", b, c), h = a.assocArraySize(f.summary) > 0 ? !0 : !1, i = a.jgrid.from(f.rows);
                    ...
                    jQuery(g).jqGrid(a.extend({
                        datastr: a.extend(i.select(), h ? {userdata: f.summary} : {}),
                        datatype: "jsonstring",
                        footerrow: h,
                        userDataOnFooter: h,
                        colModel: f.colModel,
                    ...
                    if (j.length)for (e = 0; e < j.length; e++)j[e] && j[e].groupHeaders.length && jQuery(g).jqGrid("setGroupHeaders", j[e]);
