    ...
    var d = function (d, e) {
        ...
        return f.Client.prototype = {
            ...
            positionElement: function () {
                var a = f.getDOMObjectPosition(this.domElement), b = this.div.style;
            ...
            reposition: function (a) {
                if (a && (this.domElement = f.$(a), this.domElement || this.hide()), this.domElement && this.div) {
                    var b = f.getDOMObjectPosition(this.domElement), c = this.div.style;
            ...
            TableTools = function (b, c) {
                ...
                fnGetSelected: function (a) {
                    var b, c, d = [], e = this.s.dt.aoData, f = this.s.dt.aiDisplay;
                    if (a)for (b = 0, c = f.length; c > b; b++)e[f[b]]._DTTT_selected && d.push(e[f[b]].nTr); else for (b = 0, c = e.length; c > b; b++)e[b]._DTTT_selected && d.push(e[b].nTr);
                    return d
                }, fnGetSelectedData: function () {
                    var a, b, c = [], d = this.s.dt.aoData;
                    for (a = 0, b = d.length; b > a; a++)d[a]._DTTT_selected && c.push(this.s.dt.oInstance.fnGetData(a));
                    return c
                }, fnGetSelectedIndexes: function (a) {
                    var b, c, d = [], e = this.s.dt.aoData, f = this.s.dt.aiDisplay;
                    if (a)for (b = 0, c = f.length; c > b; b++)e[f[b]]._DTTT_selected && d.push(f[b]); else for (b = 0, c = e.length; c > b; b++)e[b]._DTTT_selected && d.push(b);
                    return d
                    ...
                    var b = "";
                    if ("undefined" != typeof a.sTitle && "" !== a.sTitle)b = a.sTitle; else {
                    ...
                    var b, c, d = this.s.dt.aoColumns, e = this._fnColumnTargets(a.mColumns), f = [], g = 0, h = 0;
                    ...
                    this._fnCustomiseSettings(b), this.dom.container = d.createElement(this.s.tags.container), this.dom.container.className = this.classes.container, "none" != this.s.select.type && this._fnRowSelectConfig(), this._fnButtonDefinations(this.s.buttonSet, this.dom.container), this.s.dt.aoDestroyCallback.push({
                        ...
                        fn: function () {
                            ...
                            var b = a.inArray(c, TableTools._aInstances);
                            -1 !== b && TableTools._aInstances.splice(b, 1)
                        }
                    })
                    ...
                    var g = d.createElement(c), h = d.createElement(e), i = this._fnGetMasterSettings();
                    ...
                    for (var a = TableTools._aInstances, b = 0, c = a.length; c > b; b++)if (this.dom.table == a[b].s.dt.nTable)return a[b].s
                    ...
                    var f = this, g = a(c).offset(), h = e._collection, i = g.left, j = g.top + a(c).outerHeight(), k = a(b).height(), l = a(d).height(), m = a(b).width(), n = a(d).width();
                    ...
                    var p = a(h).outerWidth(), q = a(h).outerHeight();
                    i + p > n && (h.style.left = n - p + "px"), j + q > l && (h.style.top = j - q - a(c).outerHeight() + "px"), this.dom.collection.collection = h, this.dom.collection.background = o, setTimeout(function () {
                        a(h).animate({opacity: 1}, 500), a(o).animate({opacity: .25}, 500)
                    }, 10), this.fnResizeButtons(), a(o).click(function () {
                        f._fnCollectionHide.call(f, null, null)
                    })
                }, _fnCollectionHide: function (b, c) {
                    (null === c || "collection" != c.sExtends) && null !== this.dom.collection.collection && (a(this.dom.collection.collection).animate({opacity: 0}, 500, function () {
                        this.style.display = "none"
                    }), a(this.dom.collection.background).animate({opacity: 0}, 500, function () {
                    ...
                    if (this.s.master) {
                        ...
                        a(c.nTable).addClass(this.classes.select.table), "os" === this.s.select.type && (a(c.nTBody).on("mousedown.DTTT_Select", "tr", function (b) {
                            ...
                            var e = "tr" === this.nodeName.toLowerCase() ? this : a(this).parents("tr")[0], f = b.s.select, g = b.s.dt.oInstance.fnGetPosition(e);
                            if (e.parentNode == c.nTBody && null !== c.oInstance.fnGetData(e)) {
                                if ("os" == f.type)if (d.ctrlKey || d.metaKey)b.fnIsSelected(e) ? b._fnRowDeselect(e, d) : b._fnRowSelect(e, d); else if (d.shiftKey) {
                                    var h = b.s.dt.aiDisplay.slice(), i = a.inArray(f.lastRow, h), j = a.inArray(g, h);
                                    if (0 === b.fnGetSelected().length || -1 === i)h.splice(a.inArray(g, h) + 1, h.length); else {
                                        if (i > j) {
                                            var k = j;
                                            j = i, i = k
                                        }
                                ...
                                } else b.fnIsSelected(e) && 1 === b.fnGetSelected().length ? b._fnRowDeselect(e, d) : (b.fnSelectNone(), b._fnRowSelect(e, d)); else b.fnIsSelected(e) ? b._fnRowDeselect(e, d) : "single" == f.type ? (b.fnSelectNone(), b._fnRowSelect(e, d)) : "multi" == f.type && b._fnRowSelect(e, d);
                                f.lastRow = g
                            }
                    ...
                    var d, e, f = this, g = this._fnSelectData(b), h = (0 === g.length ? null : g[0].nTr, []);
                    ...
                    var b, c, d, e = [];
                    if (a.nodeName)b = this.s.dt.oInstance.fnGetPosition(a), e.push(this.s.dt.aoData[b]); else {
                    ...
                    var e = this, f = b.getAttribute("id");
                    ...
                    var c, d, e = [], f = this.s.dt, g = f.aoColumns, h = g.length;
                    ...
                    } else if ("visible" == b)for (c = 0, d = h; d > c; c++)e.push(g[c].bVisible ? !0 : !1); else if ("hidden" == b)for (c = 0, d = h; d > c; c++)e.push(g[c].bVisible ? !1 : !0); else if ("sortable" == b)for (c = 0, d = h; d > c; c++)e.push(g[c].bSortable ? !0 : !1); else for (c = 0, d = h; d > c; c++)e.push(!0);
                    return e
                }, _fnNewline: function (a) {
                    return "auto" == a.sNewLine ? navigator.userAgent.match(/Windows/) ? "\r\n" : "\n" : a.sNewLine
                }, _fnGetDataTablesData: function (b) {
                    var c, d, f, g, h, i, j, k = [], l = "", m = this.s.dt, n = new RegExp(b.sFieldBoundary, "g"), o = this._fnColumnTargets(b.mColumns), p = "undefined" != typeof b.bSelectedOnly ? b.bSelectedOnly : !1;
                    if (b.bHeader) {
                    ...
                    for (p = "none" !== this.s.select.type && p && 0 !== r.length, q = p ? r : e.Api ? new e.Api(m).rows(b.oSelectorOpts).indexes().flatten().toArray() : m.oInstance.$("tr", b.oSelectorOpts).map(function (a, b) {
                        ...
                        for (j = m.aoData[q[f]].nTr, h = [], c = 0, d = m.aoColumns.length; d > c; c++)if (o[c]) {
                    ...
                    var g = f.aanFeatures;
                    for (var h in g)if ("i" != h && "t" != h && 1 == h.length)for (var i = 0, j = g[h].length; j > i; i++)this.dom.print.hidden.push({
                        node: g[h][i],
                        display: "block"
                    ...
                    {
                        var c = this.s.dt, e = this.s.print;
                        this.dom.print
                    }
                    ...
                    var b, c, d = this.s.dt, e = d.nScrollHead.getElementsByTagName("div")[0], f = (e.getElementsByTagName("table")[0], d.nTable.parentNode);
                    ...
                    for (var c = this.dom.print.hidden, d = b.parentNode, e = d.childNodes, f = 0, g = e.length; g > f; f++)if (e[f] != b && 1 == e[f].nodeType) {
                ...
                for (var b = 0, c = TableTools._aInstances.length; c > b; b++)if (TableTools._aInstances[b].s.master && TableTools._aInstances[b].dom.table == a)return TableTools._aInstances[b];
                return null
                ...
                select: a.extend({}, TableTools.buttonBase, {
                    sButtonText: "Select button", fnSelect: function (b) {
            ...
            }, TableTools.defaults = TableTools.DEFAULTS, TableTools.prototype.CLASS = "TableTools", TableTools.version = "2.2.3", a.fn.dataTable.Api && a.fn.dataTable.Api.register("tabletools()", function () {
                var a = null;
                ...
                fnInit: function (a) {
                    var b = a.oInit, c = b ? b.tableTools || b.oTableTools || {} : {};
            ...
            fnInit: function (a) {
                var b = "undefined" != typeof a.oInit.oTableTools ? a.oInit.oTableTools : {}, c = new TableTools(a.oInstance, b);
