...
!function (a, b, c) {
    !function (a) {
        ...
        function h(a) {
            ...
            if (b)for (var c = 0, d = b.length; d > c; c++)b[c] && f(Wb.models.oSearch, b[c])
        }
        ...
        function j(a) {
            var b = a.oBrowser, c = d("<div/>").css({
                ...
                width: 100,
                overflow: "scroll"
            }).append(d('<div class="test"/>').css({width: "100%", height: 10}))).appendTo("body"), e = c.find(".test");
        ...
        function l(a, c) {
            var e = Wb.defaults.column, f = a.aoColumns.length, g = d.extend({}, Wb.models.oColumn, e, {
        ...
        function B(a) {
            ...
            var e = function (a, b, d) {
                ...
                if ("" !== d)for (var j = A(d), k = 0, l = j.length; l > k; k++) {
                    ...
                    if (g)j[k] = j[k].replace(uc, ""), a = a[j[k]](); else {
        ...
        function M(a) {
            ...
            if (a.bDeferLoading)a.bDeferLoading = !1, a.iDraw++, ob(a, !1); else if (k) {
            ...
            if (0 !== l.length)for (var o = k ? 0 : m, p = k ? a.aoData.length : n, r = o; p > r; r++) {
                ...
                1 == a.iDraw && "ajax" == Sb(a) ? w = i.sLoadingRecords : i.sEmptyTable && 0 === a.fnRecordsTotal() && (w = i.sEmptyTable), e[0] = d("<tr/>", {"class": h ? g[0] : ""}).append(d("<td />", {
                    valign: "top",
                    colSpan: q(a),
        ...
        function O(a) {
            ...
            for (var h, i, j, k, l, m, n = a.sDom.split(""), o = 0; o < n.length; o++) {
                if (h = null, i = n[o], "<" == i) {
                    ...
                    g.append(j), g = d(j)
                } else if (">" == i)g = g.parent(); else if ("l" == i && f.bPaginate && f.bLengthChange)h = kb(a); else if ("f" == i && f.bFilter)h = W(a); else if ("r" == i && f.bProcessing)h = nb(a); else if ("t" == i)h = pb(a); else if ("i" == i && f.bInfo)h = eb(a); else if ("p" == i && f.bPaginate)h = lb(a); else if (0 !== Wb.ext.feature.length)for (var q = Wb.ext.feature, r = 0, s = q.length; s > r; r++)if (i == q[r].cFeature) {
                    h = q[r].fnInit(a);
                    break
                }
                if (h) {
        ...
        function $(a, b, c, d, e, f) {
            ...
            if (0 !== Wb.ext.search.length && (c = !0), h = bb(a), b.length <= 0)a.aiDisplay = l.slice(); else for ((h || c || k.length > b.length || 0 !== b.indexOf(k) || a.bSorted) && (a.aiDisplay = l.slice()), g = a.aiDisplay, i = g.length - 1; i >= 0; i--)j.test(a.aoData[g[i]]._sFilterRow) || g.splice(i, 1)
        }
        ...
        function bb(a) {
            ...
            for (c = 0, e = a.aoData.length; e > c; c++)if (i = a.aoData[c], !i._aFilterData) {
                for (g = [], d = 0, f = j.length; f > d; d++)b = j[d], b.bSearchable ? (h = y(a, c, d, "filter"), k[b.sType] && (h = k[b.sType](h)), null === h && (h = ""), "string" != typeof h && h.toString && (h = h.toString())) : h = "", h.indexOf && -1 !== h.indexOf("&") && (vc.innerHTML = h, h = wc ? vc.textContent : vc.innerText), h.replace && (h = h.replace(/[\r\n]/g, "")), g.push(h);
        ...
        function sb(b) {
            ...
            if (w || m || l || p != q(b) || p != t.length) {
                ...
                if (b.aoData.length)for (c = 0; c < s.length; c++)f = s[c], e = j[f], d(wb(b, f)).clone(!1).append(e.sContentPadding).appendTo(y);
            ...
            } else for (c = 0; p > c; c++)j[c].sWidth = yb(t.eq(c).width());
        ...
        function xb(a, b) {
            for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; g > f; f++)c = y(a, f, b, "display") + "", c = c.replace(xc, ""), c.length > d && (d = c.length, e = f);
            return e
        }
        ...
        function Ab(a) {
            ...
            for (d.isArray(m) && p(m), n && m.pre && p(m.pre), p(a.aaSorting), n && m.post && p(m.post), b = 0; b < o.length; b++)for (j = o[b][0], g = l[j].aDataSort, e = 0, f = g.length; f > e; e++)h = g[e], i = l[h].sType || "string", o[b]._idx === c && (o[b]._idx = d.inArray(o[b][1], l[h].asSorting)), k.push({
                ...
                index: o[b]._idx,
                type: i,
                formatter: Wb.ext.type.order[i + "-pre"]
            });
            return k
        }
        ...
        Wb = function (a) {
            ...
            return this.each(function () {
                ...
                var D = A.oLanguage;
                d.extend(!0, D, p.oLanguage), "" !== D.sUrl && (d.ajax({
                    dataType: "json",
                    url: D.sUrl,
                    success: function (a) {
                ...
                if (0 !== J.length && (P(A.aoHeader, J[0]), I = Q(A)), null === p.aoColumns)for (G = [], q = 0, n = I.length; n > q; q++)G.push(null); else G = p.aoColumns;
                for (q = 0, n = G.length; n > q; q++)l(A, I ? I[q] : null);
                ...
                if (p.bStateSave && (L.bStateSave = !0, Ib(A, p), Ob(A, "aoDrawCallback", Hb, "state_save")), p.aaSorting === c) {
                    var M = A.aaSorting;
                    for (q = 0, n = M.length; n > q; q++)M[q][1] = A.aoColumns[q].asSorting[0]
                }
                ...
                if (0 === S.length && N.length > 0 && ("" !== A.oScroll.sX || "" !== A.oScroll.sY) && (S = d("<tfoot/>").appendTo(this)), 0 === S.length || 0 === S.children().length ? d(this).addClass(B.sNoFooter) : S.length > 0 && (A.nTFoot = S[0], P(A.aoFooter, A.nTFoot)), p.aaData)for (q = 0; q < p.aaData.length; q++)u(A, p.aaData[q]); else(A.bDeferLoading || "dom" == Sb(A)) && v(A, d(A.nTBody).children("tr"));
        ...
        Yb = function (a, b) {
            ...
            this.context = rc(c), b && this.push.apply(this, b.toArray ? b.toArray() : b), this.selector = {
                rows: null,
                cols: null,
                opts: null
            }, Yb.extend(this, this, yc)
            ...
            filter: function (a) {
                var b = [];
                if (zc.filter)b = zc.filter.call(this, a, this); else for (var c = 0, d = this.length; d > c; c++)a.call(this, this[c], c, this) && b.push(this[c]);
            ...
            join: zc.join,
            indexOf: zc.indexOf || function (a, b) {
            ...
            iterator: function (a, b, d, e) {
                ...
                for ("string" == typeof a && (e = d, d = b, b = a, a = !1), g = 0, h = o.length; h > g; g++) {
                    var q = new Yb(o[g]);
                    if ("table" === b)f = d.call(q, o[g], g), f !== c && n.push(f); else if ("columns" === b || "rows" === b)f = d.call(q, o[g], this[g], g), f !== c && n.push(f); else if ("column" === b || "column-rows" === b || "row" === b || "cell" === b)for (l = this[g], "column-rows" === b && (k = Gc(o[g], p.opts)), i = 0, j = l.length; j > i; i++)m = l[i], f = "cell" === b ? d.call(q, o[g], m.row, m.column, g, i) : d.call(q, o[g], m, g, i, k), f !== c && n.push(f)
                }
                if (n.length || e) {
            ...
            map: function (a) {
                var b = [];
                if (zc.map)b = zc.map.call(this, a, this); else for (var c = 0, d = this.length; d > c; c++)b.push(a.call(this, this[c], c));
                return new Yb(this.context, b)
            },
            pluck: function (a) {
            ...
            if (d.isArray(a))for (var c = 0, e = a.length; e > c; c++)Yb.register(a[c], b); else {
        ...
        var Dc = function (a, b) {
            ...
            if ("current" == l)for (c = a._iDisplayStart, e = a.fnDisplayEnd(); e > c; c++)g.push(h[c]); else if ("current" == k || "applied" == k)g = "none" == j ? i.slice() : "applied" == j ? h.slice() : d.map(i, function (a) {
        ...
        var Ic = function (a, b, c, e) {
            ...
            if (d.isArray(c) || c instanceof d)for (var h = 0, i = c.length; i > h; h++)g(c[h], e); else g(c, e);
            ...
            b.off(d + " " + e + " " + f), mc(g, "_details").length > 0 && (b.on(d, function (c, d) {
                ...
                if (a === c)for (var d, e = q(c), f = 0, h = g.length; h > f; f++)d = g[f], d._details && d._details.children("td[colspan]").attr("colspan", e)
            }), b.on(f, function (c, d) {
                if (a === d)for (var e = 0, f = g.length; f > e; e++)g[e]._details && Jc(b, e)
            }))
        ...
        Zb("cells()", function (a, b, e) {
            ...
            for (var b, c, d = Wb.version.split("."), e = a.split("."), f = 0, g = e.length; g > f; f++)if (b = parseInt(d[f], 10) || 0, c = parseInt(e[f], 10) || 0, b !== c)return b > c;
            return !0
        ...
        }), Wb.version = "1.10.4", Wb.settings = [], Wb.models = {}, Wb.models.oSearch = {
            bCaseInsensitive: !0,
            sSearch: "",
            bRegex: !1,
            bSmart: !0
            ...
            pageButton: {
                _: function (a, c, e, f, g, h) {
                    var i, j, k = a.oClasses, l = a.oLanguage.oPaginate, m = 0, n = function (b, c) {
                        ...
                        for (f = 0, o = c.length; o > f; f++)if (q = c[f], d.isArray(q)) {
                            ...
                            }).html(i).appendTo(b), Nb(p, {action: q}, r), m++)
                        }
                    };
                    try {
