...
!function (a) {
    ...
    var b = {
        init: function (c) {
            ...
            var b = this.opt.path + this.opt.cancelOff, c = a("<" + this.opt.starType + " />", {
            ...
            var d = b._getFirstDecimal.call(this, a), e = Math.ceil(a), f = this.opt.hints[(e || 1) - 1], g = f, h = !c || this.move;
            ...
            return this.each(function () {
                ...
                var f = b._getWidth.call(this), g = f / 10, h = a(this.stars[d]), i = h.offset().left + g * e, j = a.Event("mousemove", {pageX: i});
