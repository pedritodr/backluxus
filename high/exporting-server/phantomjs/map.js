...
(function (l) {
    function I(a, b) {
        var c, d, e, f, g = !1, h = a.x, j = a.y;
        for (c = 0, d = b.length - 1; c < b.length; d = c++)e = b[c][1] > j, f = b[d][1] > j, e !== f && h < (b[d][0] - b[c][0]) * (j - b[c][1]) / (b[d][1] - b[c][1]) + b[c][0] && (g = !g);
        return g
    }
    ...
    var o = l.Axis, r = l.Chart, w = l.Color, t = l.Point, F = l.Pointer, C = l.Legend, G = l.LegendSymbolMixin,
        N = l.Renderer, y = l.Series, H = l.SVGRenderer, K = l.VMLRenderer, L = l.addEvent, i = l.each, D = l.error, p = l.extend, u = l.extendClass, n = l.merge, m = l.pick, z = l.getOptions(), k = l.seriesTypes, v = z.plotOptions, s = l.wrap, q = function () {
        };
    s(o.prototype, "getSeriesExtremes", function (a) {
        var b = this.isXAxis, c, d, e = [], f;
        b && i(this.series, function (a, b) {
            if (a.useMapGeometry)e[b] = a.xData, a.xData = []
        });
        a.call(this);
        if (b && (c = m(this.dataMin, Number.MAX_VALUE), d = m(this.dataMax, -Number.MAX_VALUE), i(this.series, function (a, b) {
    ...
    s(o.prototype, "setAxisTranslation", function (a) {
        ...
        a.call(this);
        this.coll === "yAxis" && b.transA !== void 0 && i(this.series, function (a) {
    ...
    s(o.prototype, "render", function (a) {
        a.call(this);
        this.fixTo = null
    });
    ...
    p(B.prototype, {
        defaultColorAxisOptions: {
            ...
            var d;
            !b.rgba.length || !a.rgba.length ? a = b.raw || "none" : (a = a.rgba, b = b.rgba, d =
                b[3] !== 1 || a[3] !== 1, a = (d ? "rgba(" : "rgb(") + Math.round(b[0] + (a[0] - b[0]) * (1 - c)) + "," + Math.round(b[1] + (a[1] - b[1]) * (1 - c)) + "," + Math.round(b[2] + (a[2] - b[2]) * (1 - c)) + (d ? "," + (b[3] + (a[3] - b[3]) * (1 - c)) : "") + ")");
            return a
        }, initDataClasses: function (a) {
            var b = this, c = this.chart, d, e = 0, f = this.options, g = a.dataClasses.length;
            this.dataClasses = d = [];
            this.legendItems = [];
            i(a.dataClasses, function (a, j) {
                var i, a = n(a);
                d.push(a);
                if (!a.color)f.dataClassColor === "category" ? (i = c.options.colors, a.color = i[e++], e === i.length && (e = 0)) : a.color =
            ...
            var c = a.padding, d = a.options, e = this.horiz, f = m(d.symbolWidth, e ? 200 : 12), g = m(d.symbolHeight, e ? 12 : 200), h = m(d.labelPadding, e ? 16 : 30), d = m(d.itemDistance, 10);
            this.setLegendColor();
            ...
            if (b)e = this.toPixels(b[b.series.colorKey]), e < f ? e = f - 2 : e > f + g && (e = f + g + 2), b.plotX = e, b.plotY = this.len - e, o.prototype.drawCrosshair.call(this, a, b), b.plotX = c, b.plotY = d, this.cross && this.cross.attr({fill: this.crosshair.color}).add(this.legendGroup)
            ...
            if (a.dataClasses)i(d.allItems, function (a) {
            ...
            var a =
                this, b = this.chart, c = this.legendItems, d = b.options.legend, e = d.valueDecimals, f = d.valueSuffix || "", g;
            c.length || i(this.dataClasses, function (d, j) {
                var x = !0, A = d.from, m = d.to;
                g = "";
                A === void 0 ? g = "< " : m === void 0 && (g = "> ");
                A !== void 0 && (g += l.numberFormat(A, e) + f);
                A !== void 0 && m !== void 0 && (g += " - ");
                m !== void 0 && (g += l.numberFormat(m, e) + f);
                c.push(p({
                    chart: b,
                    name: g,
                    options: {},
    ...
    i(["fill", "stroke"], function (a) {
        HighchartsAdapter.addAnimSetter(a, function (b) {
            b.elem.attr(a, B.prototype.tweenColors(w(b.start), w(b.end), b.pos))
        })
    });
    s(r.prototype, "getAxes", function (a) {
        var b = this.options.colorAxis;
        a.call(this);
        this.colorAxis = [];
        b && new B(this, b)
    });
    s(C.prototype, "getAllItems", function (a) {
    ...
    p(r.prototype, {
        renderMapNavigation: function () {
            ...
            if (m(b.enableButtons, b.enabled) && !a.renderer.forExport)for (d in c)if (c.hasOwnProperty(d))f = n(b.buttonOptions, c[d]), e = f.theme, e.style = n(f.theme.style, f.style), g = e.states, e = a.renderer.button(f.text, 0, 0, h, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" :
                "bottombutton").attr({
                width: f.width,
                height: f.height,
                title: a.options.lang[d],
                zIndex: 5
            }).add(), e.handler = f.onclick, e.align(p(f, {width: e.width, height: 2 * e.height}), null, f.alignTo)
            ...
            var f = this.xAxis[0], g = f.max - f.min, h = m(b, f.min + g / 2), j = g * a, g = this.yAxis[0], i = g.max -
                g.min, A = m(c, g.min + i / 2);
            i *= a;
            h = this.fitToBox({
                x: h - j * (d ? (d - f.pos) / f.len : 0.5),
                y: A - i * (e ? (e - g.pos) / g.len : 0.5),
                width: j,
                height: i
    ...
    s(r.prototype, "render", function (a) {
        ...
        a.call(b);
        (m(c.enableDoubleClickZoom, c.enabled) || c.enableDoubleClickZoomTo) && L(b.container, "dblclick", function (a) {
            b.pointer.onContainerDblClick(a)
        });
        m(c.enableMouseWheelZoom, c.enabled) && L(b.container, document.onmousewheel === void 0 ? "DOMMouseScroll" : "mousewheel", function (a) {
    ...
    p(F.prototype, {
        onContainerDblClick: function (a) {
            ...
            b.options.mapNavigation.enableDoubleClickZoomTo ? b.pointer.inClass(a.target, "highcharts-tracker") &&
    ...
    var M = u(t, {
        applyOptions: function (a, b) {
            ...
            var a = this, b = +new Date, c = w(a.color), d = w(a.pointAttr.hover.fill), e = a.series.options.states.normal.animation, f = e && (e.duration || 500), g;
    ...
    k.map = u(k.scatter, n(C, {
        ...
        getBox: function (a) {
            var b = Number.MAX_VALUE, c = -b, d = b, e = -b, f = b, g = b, h = this.xAxis, j = this.yAxis, x;
            i(a || [], function (a) {
                if (a.path) {
                    if (typeof a.path === "string")a.path = l.splitPath(a.path);
                    var h = a.path || [], j = h.length, i = !1, k = -b, n = b, p = -b, o = b, q = a.properties;
                    if (!a._foundBox) {
                        for (; j--;)typeof h[j] === "number" && !isNaN(h[j]) && (i ? (k = Math.max(k, h[j]), n = Math.min(n, h[j])) : (p = Math.max(p, h[j]), o = Math.min(o,
                            h[j])), i = !i);
                        a._midX = n + (k - n) * (a.middleX || q && q["hc-middle-x"] || 0.5);
                        a._midY = o + (p - o) * (a.middleY || q && q["hc-middle-y"] || 0.5);
                        a._maxX = k;
                        a._minX = n;
                        a._maxY = p;
                        a._minY = o;
                        a.labelrank = m(a.labelrank, (k - n) * (p - o));
                        a._foundBox = !0
                    }
            ...
            if (x) {
                ...
                this.maxX = Math.max(c, m(this.maxX,
                    -b));
        ...
        translatePath: function (a) {
            var b = !1, c = this.xAxis, d = this.yAxis,
                e = c.min, f = c.transA, c = c.minPixelPadding, g = d.min, h = d.transA, d = d.minPixelPadding, j, i = [];
            if (a)for (j = a.length; j--;)typeof a[j] === "number" ? (i[j] = b ? (a[j] - e) * f + c : (a[j] - g) * h + d, b = !b) : i[j] = a[j];
            return i
        },
        setData: function (a, b) {
            var c = this.options, d = c.mapData, e = c.joinBy, f = e === null, g = [], h, j, k;
            f && (e = "_i");
            ...
            if (d) {
                if (d.type === "FeatureCollection") {
                    if (d["hc-transform"])for (h in this.chart.mapTransforms =
                        j = d["hc-transform"], j)if (j.hasOwnProperty(h) && h.rotation)h.cosAngle = Math.cos(h.rotation), h.sinAngle = Math.sin(h.rotation);
                    d = l.geojson(d, this.type, this)
                }
                this.getBox(d);
                this.mapData = d;
                this.mapMap = {};
                for (k = 0; k < d.length; k++)h = d[k], j = h.properties, h._i = k, e[0] && j && j[e[0]] && (h[e[0]] = j[e[0]]), this.mapMap[h[e[0]]] = h;
        ...
        translate: function () {
            ...
            i(a.data, function (e) {
                ...
                if (d)e.shapeType = "path", e.shapeArgs = {d: a.translatePath(e.path)}, E && (e.shapeArgs["vector-effect"] = "non-scaling-stroke")
            });
            a.translateColors()
        },
        drawPoints: function () {
            var a = this,
                b = a.xAxis, c = a.yAxis, d = a.group, e = a.chart, f = e.renderer, g, h = this.baseTrans;
            if (!a.transformGroup)a.transformGroup = f.g().attr({
                scaleX: 1,
                scaleY: 1
            }).add(d), a.transformGroup.survive = !0;
            a.doFullTranslate() ? (e.hasRendered && a.pointAttrToOptions.fill === "color" && i(a.points, function (a) {
                a.graphic && a.graphic.attr("fill", a.color)
            }), E || i(a.points, function (b) {
                b = b.pointAttr[""];
                ...
                a.group = d, i(a.points, function (a) {
    ...
    v.mapline = n(v.map, {lineWidth: 1, fillColor: "none"});
    k.mapline = u(k.map, {
        type: "mapline",
    ...
    k.mappoint = u(k.scatter, {
        type: "mappoint", forceDL: !0, pointClass: u(t, {
            applyOptions: function (a, b) {
                var c = t.prototype.applyOptions.call(this,
                    a, b);
                a.lat !== void 0 && a.lon !== void 0 && (c = p(c, this.series.chart.fromLatLonToPoint(c)));
                return c
            }
        })
    });
    if (k.bubble)v.mapbubble = n(v.bubble, {
        animationLimit: 500,
        ...
        pointClass: u(t, {
            applyOptions: function (a, b) {
                var c;
                a.lat !== void 0 && a.lon !== void 0 ? (c = t.prototype.applyOptions.call(this, a, b), c = p(c, this.series.chart.fromLatLonToPoint(c))) : c = M.prototype.applyOptions.call(this, a, b);
                return c
            }, ttBelow: !1
            ...
            translate: function () {
                ...
                i(this.points, function (d) {
                    var e = (a.colsize || 1) / 2, f = (a.rowsize || 1) / 2, g = Math.round(b.len - b.translate(d.x -
                            e, 0, 1, 0, 1)), e = Math.round(b.len - b.translate(d.x + e, 0, 1, 0, 1)), h = Math.round(c.translate(d.y - f, 0, 1, 0, 1)), f = Math.round(c.translate(d.y + f, 0, 1, 0, 1));
    ...
    r.prototype.transformToLatLon = function (a, b) {
        if (window.proj4 === void 0)D(21); else {
            ...
            }, d = b.cosAngle || b.rotation && Math.cos(b.rotation), e = b.sinAngle || b.rotation && Math.sin(b.rotation), c = window.proj4(b.crs, "WGS84",
                b.rotation ? {x: c.x * d + c.y * -e, y: c.x * e + c.y * d} : c);
            return {lat: c.y, lon: c.x}
        }
    };
    r.prototype.fromPointToLatLon = function (a) {
        var b = this.mapTransforms, c;
        if (b) {
            for (c in b)if (b.hasOwnProperty(c) && b[c].hitZone && I({
                    x: a.x,
                    y: -a.y
    ...
    r.prototype.fromLatLonToPoint = function (a) {
        var b = this.mapTransforms, c, d;
        if (!b)return D(22), {x: 0, y: null};
        for (c in b)if (b.hasOwnProperty(c) && b[c].hitZone && (d = this.transformFromLatLon(a,
                b[c]), I({x: d.x, y: -d.y}, b[c].hitZone.coordinates[0])))return d;
    ...
    l.geojson = function (a, b, c) {
        ...
        i(a.features, function (a) {
            var c = a.geometry, j = c.type, c = c.coordinates, a = a.properties, k;
            e = [];
            b === "map" || b === "mapbubble" ? (j === "Polygon" ? (i(c, f), e.push("Z")) : j === "MultiPolygon" && (i(c, function (a) {
                i(a, f)
            }), e.push("Z")), e.length && (k = {path: e})) : b ===
            "mapline" ? (j === "LineString" ? f(c) : j === "MultiLineString" && i(c, f), e.length && (k = {path: e})) : b === "mappoint" && j === "Point" && (k = {
                x: c[0],
                y: -c[1]
            });
            k && d.push(p(k, {name: a.name || a.NAME, properties: a}))
        });
    ...
    H.prototype.symbols.topbutton = function (a, b, c, d, e) {
        return J(a - 1, b - 1, c, d, e.r, e.r, 0, 0)
    };
    H.prototype.symbols.bottombutton = function (a, b, c, d, e) {
        return J(a - 1, b - 1, c, d, 0, 0, e.r, e.r)
    };
    N === K && i(["topbutton", "bottombutton"], function (a) {
        K.prototype.symbols[a] = H.prototype.symbols[a]
    });
    l.Map = function (a, b) {
        var c = {
