(function (f) {
    ...
    var t = function () {
        }, q = f.getOptions(), h = f.each, l = f.extend, B = f.format, u = f.pick, r = f.wrap, m = f.Chart, p = f.seriesTypes, v = p.pie, n = p.column, w = f.Tick, x = HighchartsAdapter.fireEvent, y = HighchartsAdapter.inArray,
        z = 1;
    ...
    l(q.lang, {drillUpText: "◁ Back to {series.name}"});
    q.drilldown = {
    ...
    f.SVGRenderer.prototype.Element.prototype.fadeIn =
        function (b) {
            this.attr({
                opacity: 0.1,
                visibility: "inherit"
            }).animate({opacity: u(this.newOpacity, 1)}, b || {duration: 250})
        };
    ...
    m.prototype.addSingleSeriesAsDrilldown = function (b, a) {
        var c = b.series, d = c.xAxis, g = c.yAxis, e;
        e = b.color || c.color;
        var i, f = [], j = [], k, o;
    ...
    m.prototype.showDrillUpButton = function () {
        var b = this, a = this.getDrilldownBackText(), c = b.options.drilldown.drillUpButton, d, g;
    ...
    m.prototype.drillUp = function () {
        ...
        }; d--;)if (i = a[d], i.levelNumber === c) {
            a.pop();
            f = i.lowerSeries;
            if (!f.chart)for (e = g.length; e--;)if (g[e].options.id === i.lowerSeriesOptions.id && g[e].options._levelNumber === c + 1) {
                f = g[e];
                break
            }
            f.xData = [];
            h(i.levelSeriesOptions, k);
            x(b, "drillup", {seriesOptions: i.seriesOptions});
        ...
        if (!b) {
            ...
            setTimeout(function () {
                ...
                h(a.points, function (a, b) {
                    var e = b === (c && c.pointIndex) ? "show" : "fadeIn", f = e === "show" ? !0 : void 0;
    ...
    n.prototype.animateDrilldown = function (b) {
        var a = this, c = this.chart.drilldownLevels, d, g = this.chart.options.drilldown.animation, e = this.xAxis;
        if (!b)h(c, function (b) {
            ...
            a.graphic && a.graphic.attr(d).animate(l(a.shapeArgs, {fill: a.color}), g);
            a.dataLabel && a.dataLabel.fadeIn(g)
        }), this.animate = null
    };
    n.prototype.animateDrillupFrom = function (b) {
        var a = this.chart.options.drilldown.animation, c = this.group, d = this;
        h(d.trackerGroups, function (a) {
            if (d[a])d[a].on("mouseover")
        });
        delete this.group;
        h(this.points, function (d) {
            var e = d.graphic, i = function () {
                e.destroy();
                c && (c = c.destroy())
            };
    ...
    v && l(v.prototype, {
        ...
        animateDrilldown: function (b) {
            var a = this.chart.drilldownLevels[this.chart.drilldownLevels.length - 1], c = this.chart.options.drilldown.animation, d = a.shapeArgs, g = d.start, e = (d.end - g) / this.points.length;
    ...
    f.Point.prototype.doDrilldown = function (b, a) {
        var c = this.series.chart, d = c.options.drilldown, f = (d.series || []).length, e;
    ...
    w.prototype.drillable = function () {
        var b = this.pos, a = this.label, c = this.axis, d = c.ddPoints && c.ddPoints[b];
        if (a && d && d.length) {
    ...
    r(f.Point.prototype, "init", function (b, a, c, d) {
        var g = b.call(this, a, c, d), b = (c = a.xAxis) && c.ticks[d], c = c && c.getDDPoints(d, a.options._levelNumber);
    ...
    r(f.Series.prototype, "drawDataLabels", function (b) {
        ...
        h(this.points, function (b) {
            b.drilldown && b.dataLabel && b.dataLabel.attr({"class": "highcharts-drilldown-data-label"}).css(a)
        })
    });
    var s, q = function (b) {
        b.call(this);
